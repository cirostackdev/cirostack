                ...
                <div className="grid md:grid-cols-[1fr_2fr] gap-12 lg:gap-20 items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                            We partner with forward-thinking organizations ranging from agile startups to established enterprises to deliver <strong>{industry.title}</strong> solutions that drive true market leadership.
                        </p>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        {industry.whoWeHelped.map((profile, idx) => (
                            <motion.div
                                key={idx}
