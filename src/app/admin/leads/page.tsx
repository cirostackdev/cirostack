                  ...
                  <tr key={lead.id} className={`border-b border-border last:border-0 ${i % 2 === 0 ? "" : "bg-muted/20"}`}>
                    ...
                    <td className="px-4 py-2.5">
                      <button
                        ...
                        className={`inline-flex items-center justify-center w-[86px] text-xs px-2 py-0.5 rounded-full font-semibold capitalize hover:opacity-80 transition-opacity ${LEAD_STATUS_COLORS[leadStatus] ?? "bg-muted text-muted-foreground"}`}
                      >
                        {leadStatus}
