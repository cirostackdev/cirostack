  ...
  return (
    <div className={`flex ${isAgent ? "justify-end" : "justify-start"} mb-3`}>
      <div className={`max-w-[85%] sm:max-w-[72%] flex flex-col ${isAgent ? "items-end" : "items-start"}`}>
        ...
        {isImage ? (
          <div className={`p-2 rounded-2xl ${isAgent ? "bg-indigo-600/20 rounded-tr-md" : "bg-zinc-800 rounded-tl-md"}`}>
          ...
          <div className={`p-3.5 rounded-2xl ${isAgent ? "bg-indigo-600/20 rounded-tr-md" : "bg-zinc-800 rounded-tl-md"} max-w-[220px] w-full`}>
