...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: `https://cirostack.com/api/og?title=${encodeURIComponent(&bg=%2Fimages%2Fpages%2Fhero-portfolio.jpg"Portfolio | CiroStack")}&description=${encodeURIComponent("Real projects, real results. Browse case studies across fintech, healthcare, SaaS, e-commerce, and more.")}&label=${encodeURIComponent("Portfolio")}`, width: 1200, height: 630, alt: "CiroStack Portfolio" }],
