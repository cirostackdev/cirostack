...
export const metadata: Metadata = {
  ...
  description: "We build websites, mobile apps, and AI automation solutions for growing businesses. Fixed-price engagements, senior engineers, delivery in weeks, not months.",
