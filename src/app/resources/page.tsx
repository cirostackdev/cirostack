...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Resources | CiroStack",
    description: "Guides, templates, and tools for software teams and founders.",
    images: [{ url: "https://cirostack.com/api/og?bg=/images/pages/hero-resources.jpg", width: 1200, height: 630, alt: "CiroStack Resources" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Resources | CiroStack",
    description: "Guides, templates, and tools for software teams and founders.",
    images: ["https://cirostack.com/api/og?bg=/images/pages/hero-resources.jpg"],
  },
};
