...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://cirostack.com/images/pages/hero-events.jpg", width: 1200, height: 630, alt: "CiroStack Events" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Events | CiroStack",
    description: "CiroStack events, workshops, and meetups for software teams and founders.",
    images: ["https://cirostack.com/images/pages/hero-events.jpg"],
  },
};
