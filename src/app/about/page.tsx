...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: `https://cirostack.com/api/og?title=${encodeURIComponent("About CiroStack")}&description=${encodeURIComponent("Senior engineers, fixed-price engagements, and a track record across fintech, healthcare, e-commerce, and SaaS.")}&label=${encodeURIComponent("About")}`, width: 1200, height: 630, alt: "About CiroStack" }],
