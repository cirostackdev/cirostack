...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "About CiroStack | Senior Engineers, Fixed Prices, Real Results",
    description: "We started CiroStack to bring senior engineering quality to growing businesses, without enterprise price tags or offshore gambles. Meet the team behind 50+ shipped projects across fintech, healthcare, and SaaS.",
    images: ["https://cirostack.com/og/pages/about.jpg"],
  },
};
