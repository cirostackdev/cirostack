...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://cirostack.com/images/pages/hero-newsletter.jpg", width: 1200, height: 630, alt: "CiroStack Newsletter" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Newsletter | CiroStack",
    description: "Subscribe to the CiroStack newsletter for software insights, case studies, and engineering updates.",
    images: ["https://cirostack.com/images/pages/hero-newsletter.jpg"],
  },
};
