...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: `https://cirostack.com/api/og?title=${encodeURIComponent("Services | CiroStack")}&description=${encodeURIComponent("Custom software, mobile apps, AI automation, cloud engineering, and UX/UI design. Fixed-price engagements with senior engineers.")}&label=${encodeURIComponent("Services")}`, width: 1200, height: 630, alt: "CiroStack Services" }],
