...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://cirostack.com/api/og?title=${encodeURIComponent("Industries We Serve | CiroStack")}&description=${encodeURIComponent("Custom software for healthcare, finance, retail, education, manufacturing, logistics, and 14 more industries.")}&label=${encodeURIComponent("Industries")}`, width: 1200, height: 630, alt: "CiroStack Industries" }],
  },
};
