...
function generateServiceApplications(id: string, category: string): StartupServiceApplication[] {
  const verticalServices: Record<string, StartupServiceApplication[]> = {
    ...
    "b2b-saas": [
      ...
      { serviceName: "Multi-Tenant Cloud Architecture", slug: "cloud-consulting", description: "SaaS infrastructure strategy and tenant operations", applicationDetail: "Tenant isolation at the infrastructure level, per-tenant resource limits, SOC 2 logging configuration, feature flags per plan, and the cloud architecture that enterprise procurement teams expect to see." },
    ],
    "consumer-apps": [
    ...
    "non-technical-founder": [
      ...
      { serviceName: "Startup Brand Identity", slug: "startup-branding", description: "Professional brand without the agency overhead", applicationDetail: "Logo, colour palette, typography, and brand guidelines that make your startup look established from day one. Fixed price, clear timeline, and no creative jargon — yours to own forever." },
    ],
    "first-time-founder": [
    ...
    "solo-founder": [
      ...
      { serviceName: "Solo Founder Brand Identity", slug: "startup-branding", description: "Professional brand without a creative team", applicationDetail: "Logo, colour system, and brand guidelines delivered in two weeks at a fixed price. Looks like you have a full design team behind you — without the overhead of managing one." },
    ],
    "repeat-founder": [
    ...
    "scaling-tech": [
      ...
      { serviceName: "Scaling Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure strategy for your growth trajectory", applicationDetail: "Assessment of current infrastructure against your growth projections, identification of the cloud architecture changes with the highest impact, and a prioritised roadmap that fixes the right things first." },
    ...
    "fundraising-ready": [
      ...
      { serviceName: "Production Observability", slug: "devops", description: "Monitoring and uptime evidence for investors", applicationDetail: "Uptime monitoring, error tracking, performance dashboards, and security scanning — the operational maturity evidence that demonstrates you run a production system, not a demo environment." },
    ],
    "ai-integration": [
    ...
    "no-tech-team": [
      ...
      { serviceName: "Backend Development", slug: "backend-development", description: "Backend built and owned end-to-end", applicationDetail: "Database design, API development, authentication, integrations, and server-side logic — all built, documented, and handed over so your product runs reliably without you needing to understand the internals." },
    ],
    "africa-launch": [
    ...
    "retainer": [
      ...
      { serviceName: "Infrastructure Management", slug: "devops", description: "Hosting, monitoring, and operational maintenance", applicationDetail: "Server management, cost optimisation, uptime monitoring, and the ongoing operational work that keeps your product running reliably without you needing a dedicated DevOps hire." },
    ],
    "nearshore": [
