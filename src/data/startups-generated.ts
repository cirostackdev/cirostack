...
function generateServiceApplications(id: string, category: string): StartupServiceApplication[] {
  const verticalServices: Record<string, StartupServiceApplication[]> = {
    "fintech": [
      { serviceName: "Payment Platform Development", slug: "frontend-development", description: "PCI-DSS compliant payment infrastructure", applicationDetail: "We build payment processing systems with tokenization, fraud scoring, and multi-rail support (ACH, wire, card, crypto) that pass compliance audits on the first attempt." },
    ...
    "healthtech": [
      { serviceName: "Telehealth Platform Development", slug: "frontend-development", description: "HIPAA-compliant video and patient management", applicationDetail: "WebRTC video consultation with waiting rooms, screen sharing, HIPAA-compliant recording, and automatic failover to phone when bandwidth drops." },
    ...
    "edtech": [
      { serviceName: "Learning Platform Development", slug: "frontend-development", description: "Scalable LMS and course delivery systems", applicationDetail: "Course creation tools, progress tracking, assessment engines, and adaptive learning paths that handle 500K concurrent users during peak enrollment." },
    ...
    "proptech": [
      { serviceName: "Property Platform Development", slug: "frontend-development", description: "Listing, search, and transaction systems", applicationDetail: "MLS-compliant property search with geospatial queries, saved searches, alerts, and the listing detail pages that convert browsers into leads." },
    ...
    "legaltech": [
      { serviceName: "Legal Platform Development", slug: "frontend-development", description: "Case management and document systems", applicationDetail: "Matter management, document assembly, time tracking, and billing systems built for the workflows that legal professionals actually follow." },
    ...
    "logistics-tech": [
      { serviceName: "Fleet Management Platform", slug: "frontend-development", description: "Real-time tracking and dispatch systems", applicationDetail: "Live fleet dashboards with vehicle status, driver assignment, route visualization, and the exception management that dispatchers need in real-time." },
    ...
    "ecommerce": [
      { serviceName: "Headless Commerce Development", slug: "frontend-development", description: "Custom storefront and backend systems", applicationDetail: "Next.js storefronts with composable commerce backends: product catalog, cart, checkout, and order management decoupled for maximum performance." },
    ...
    "b2b-saas": [
      { serviceName: "SaaS Platform Development", slug: "frontend-development", description: "Multi-tenant application architecture", applicationDetail: "Core platform with tenant isolation, admin consoles, usage dashboards, and the self-serve onboarding that converts free trials into paid subscriptions." },
    ...
    "consumer-apps": [
      { serviceName: "Consumer App Development", slug: "frontend-development", description: "Engagement-optimized application platforms", applicationDetail: "Backend services for feeds, profiles, notifications, and the real-time features (chat, reactions, live updates) that drive daily active usage." },
    ...
    "mobile-app": [
      { serviceName: "Cross-Platform Development", slug: "frontend-development", description: "React Native for iOS and Android", applicationDetail: "Single codebase serving both platforms with 90%+ code sharing while maintaining native-feel performance, platform-specific UI patterns, and smooth animations." },
    ...
    "saas-platform": [
      { serviceName: "Platform Development", slug: "frontend-development", description: "Multi-tenant application core", applicationDetail: "Tenant isolation, admin consoles, user management, and the subscription enforcement layer that gates features by plan level across your entire application." },
    ...
    "marketplace": [
      { serviceName: "Marketplace Platform", slug: "frontend-development", description: "Two-sided marketplace core", applicationDetail: "Separate buyer and seller experiences, listing management, search and discovery, and the matching logic that connects supply with demand effectively." },
      ...
      { serviceName: "Trust & Safety Infrastructure", slug: "software-auditing", description: "Fraud detection and content moderation", applicationDetail: "Automated fraud scoring, content moderation queues, user verification workflows, and the dispute resolution system that scales beyond manual review." },
    ],
    "api-product": [
      { serviceName: "API Development", slug: "frontend-development", description: "RESTful or GraphQL API architecture", applicationDetail: "Endpoint design, authentication (API keys, OAuth), pagination, filtering, and the consistent error handling that makes your API predictable for developers." },
    ...
    // BY FOUNDER TYPE
    "non-technical-founder": [
      { serviceName: "Full Product Development", slug: "frontend-development", description: "End-to-end product build with all decisions owned", applicationDetail: "We handle architecture, framework selection, database design, and infrastructure. You handle business decisions. Weekly updates explain what was built and why." },
    ...
    "first-time-founder": [
      { serviceName: "MVP Development", slug: "frontend-development", description: "Lean first product with maximum learning", applicationDetail: "The minimum set of features that tests your core hypothesis. Built to production quality so what you ship to users becomes what you scale." },
    ...
    "solo-founder": [
      { serviceName: "Autonomous Development", slug: "frontend-development", description: "Full engineering department as a service", applicationDetail: "Frontend, backend, database, and infrastructure handled independently. You approve direction weekly. No daily management required." },
    ...
    "repeat-founder": [
      { serviceName: "Senior Engineering", slug: "frontend-development", description: "Code quality matching your standards", applicationDetail: "Clean architecture, proper testing, meaningful code review. Engineers who write code you would be proud to show during technical due diligence." },
    ...
    "student-startup": [
      { serviceName: "Demo Day MVP", slug: "frontend-development", description: "Working product scoped to your deadline", applicationDetail: "A real product (not a prototype) that demonstrates your concept, handles real users, and impresses judges and investors. Delivered before your deadline." },
    ...
    "corporate-innovator": [
      { serviceName: "Enterprise-Grade Development", slug: "frontend-development", description: "Startup product meeting corporate standards", applicationDetail: "Agile delivery with the documentation, security controls, and audit trail that enterprise governance requires. Speed without compliance shortcuts." },
    ...
    "female-led": [
      { serviceName: "Full Product Development", slug: "frontend-development", description: "Engineering partnership on equal terms", applicationDetail: "Complete product development with transparent pricing, senior engineers, and communication that respects your expertise and time." },
    ...
    "african-startup": [
      { serviceName: "African Market Development", slug: "frontend-development", description: "Products built for real African infrastructure", applicationDetail: "Web and mobile applications optimized for low bandwidth, intermittent connectivity, and the device landscape your actual users have." },
    ...
    "diaspora-founder": [
      { serviceName: "Multi-Market Platform", slug: "frontend-development", description: "One product serving multiple countries", applicationDetail: "Architecture that handles multi-currency, multi-language, and multi-regulation requirements without maintaining separate codebases for each market." },
    ...
    "social-enterprise": [
      { serviceName: "Impact-Focused Development", slug: "frontend-development", description: "Technology that maximizes social outcome", applicationDetail: "Features prioritized by impact per development dollar. Nothing built because it is technically interesting. Everything built because it moves your mission forward." },
    ...
    // BY CHALLENGE
    "fast-mvp": [
      { serviceName: "Rapid Product Development", slug: "frontend-development", description: "MVP shipped in 4-6 weeks", applicationDetail: "Full-stack development at startup speed: scope on Monday, build Tuesday through Friday, ship working software every two weeks until the product is complete." },
    ...
    "scaling-tech": [
      ...
      { serviceName: "Architecture Remediation", slug: "backend-development", description: "Targeted fixes for scaling bottlenecks", applicationDetail: "Database indexing, query optimization, caching layers, connection pooling, and the targeted interventions that resolve 80% of performance issues without rewriting." },
    ...
    "agency-rescue": [
      { serviceName: "Codebase Assessment", slug: "frontend-development", description: "Honest evaluation of what you have", applicationDetail: "Complete codebase review: security vulnerabilities, architecture quality, test coverage, documentation state. Written report with salvage-vs-replace recommendations." },
    ...
    "fundraising-ready": [
      { serviceName: "Security Hardening", slug: "frontend-development", description: "Vulnerability remediation and hardening", applicationDetail: "Dependency updates, vulnerability patches, encryption verification, access control audit, and the security posture that survives investor-commissioned CTO review." },
      ...
      { serviceName: "Load Testing", slug: "software-auditing", description: "Performance under growth projections", applicationDetail: "Simulated traffic at 10x current load. Breaking points identified and documented. Report proves architecture handles the growth narrative in your pitch." },
    ...
    "tech-debt": [
      { serviceName: "Debt Audit", slug: "frontend-development", description: "Codebase analysis and prioritization", applicationDetail: "Every piece of technical debt scored by velocity impact and reliability risk. Prioritized remediation plan that fixes the highest-impact debt first." },
      { serviceName: "Incremental Modernization", slug: "devops", description: "Strangler fig refactoring", applicationDetail: "Problematic modules replaced one at a time with clean implementations. Feature development continues in parallel. No velocity freeze required." },
      { serviceName: "Testing Implementation", slug: "software-auditing", description: "Automated test coverage on critical paths", applicationDetail: "Integration and unit tests added to the code paths that break most often. Each test prevents a category of future regressions." },
    ...
    "post-pivot": [
      { serviceName: "Codebase Triage", slug: "frontend-development", description: "Salvage-vs-replace assessment", applicationDetail: "Every module evaluated for applicability to the new direction. Honest assessment: keep, modify, or discard. Delivered in 1-2 weeks with cost estimates for each path." },
    ...
    "no-tech-team": [
      { serviceName: "Full-Stack Development", slug: "frontend-development", description: "Complete engineering as a service", applicationDetail: "Frontend, backend, database, API design, and infrastructure. Every engineering role covered by one engagement. No gaps, no coordination between vendors." },
    ...
    "africa-launch": [
      { serviceName: "Market Adaptation", slug: "frontend-development", description: "Product re-architecture for African markets", applicationDetail: "Your existing product adapted for low bandwidth, mobile money, offline capability, and the device landscape of your target African markets." },
    ...
    // BY ENGAGEMENT
    "fixed-price-mvp": [
      { serviceName: "Scoped MVP Development", slug: "frontend-development", description: "Fixed-price product delivery", applicationDetail: "Scope defined, price locked, timeline agreed. Development proceeds with milestone payments on working software. No hourly billing, no surprise costs." },
    ...
    "dedicated-team": [
      { serviceName: "Embedded Engineering", slug: "frontend-development", description: "Full-stack team in your workflow", applicationDetail: "2-8 engineers attending your standups, using your tools, following your standards. They know your codebase because they have been in it for months." },
    ...
    "tech-cofounder": [
      { serviceName: "Technical Strategy", slug: "frontend-development", description: "CTO-level architecture and direction", applicationDetail: "Technology selection, system design, scalability planning, and the long-term technical vision that guides every daily engineering decision." },
    ...
    "cto-as-a-service": [
      { serviceName: "Architecture Reviews", slug: "frontend-development", description: "System design evaluation and direction", applicationDetail: "Weekly architecture reviews that resolve technical debates, set direction, and ensure your team builds consistently toward the 2-year technical vision." },
    ...
    "design-sprint": [
      { serviceName: "Sprint Facilitation", slug: "frontend-development", description: "Structured 5-day product validation", applicationDetail: "Monday: problem definition. Tuesday: solution sketching. Wednesday: decision and storyboarding. Thursday: prototype building. Friday: user testing." },
    ...
    "code-audit": [
      { serviceName: "Codebase Review", slug: "frontend-development", description: "Architecture and code quality assessment", applicationDetail: "Complete review of code structure, patterns, test coverage, dependency health, and architecture sustainability. Findings scored by severity and impact." },
    ...
    "staff-augmentation": [
      { serviceName: "Senior Engineer Placement", slug: "frontend-development", description: "Individual contributors joining your team", applicationDetail: "1-3 senior engineers integrated into your existing workflow. They attend your standups, follow your process, and contribute code through your review system." },
    ...
    "retainer": [
      { serviceName: "Ongoing Development", slug: "frontend-development", description: "Continuous feature delivery", applicationDetail: "Monthly capacity for feature development, improvements, and iterations. Same engineers every month who know your codebase and can estimate accurately." },
    ...
    "nearshore": [
      { serviceName: "Nearshore Engineering", slug: "frontend-development", description: "Senior engineers in your timezone", applicationDetail: "Full-stack engineers within 2 hours of your timezone. Real-time collaboration, pair programming capability, and zero async-only communication days." },
    ...
    "outsourcing": [
      { serviceName: "Project Delivery", slug: "frontend-development", description: "End-to-end product development", applicationDetail: "Requirements in, working software out. We own architecture, development, testing, deployment, and documentation. One contract, one deliverable." },
