...
function generateServiceApplications(id: string, category: string): StartupServiceApplication[] {
  const verticalServices: Record<string, StartupServiceApplication[]> = {
    "fintech": [
      { serviceName: "Financial Backend Engineering", slug: "backend-development", description: "Payment APIs, banking integrations, and financial logic", applicationDetail: "We build payment processing systems with tokenization, multi-rail support (ACH, wire, card), Plaid and Stripe Connect integrations, and the idempotency logic that keeps money safe when APIs fail mid-transaction." },
      { serviceName: "Fintech Dashboard Development", slug: "frontend-development", description: "Trading UIs, banking dashboards, and compliance interfaces", applicationDetail: "Admin consoles, transaction monitoring dashboards, and customer-facing financial interfaces built for the trust signals and visual restraint that financial products demand." },
      { serviceName: "Compliance Cloud Architecture", slug: "cloud-consulting", description: "PCI-DSS and SOC 2 ready infrastructure strategy", applicationDetail: "Cloud architecture where compliance is designed in from day one. PCI-DSS scope minimisation, SOC 2 evidence automation, and provider configurations that pass financial audits without last-minute scrambles." },
      { serviceName: "Fintech Security Audit", slug: "software-auditing", description: "Security posture and compliance gap assessment", applicationDetail: "Full codebase and infrastructure review against PCI-DSS, SOC 2, and financial data protection requirements. Every finding scored by risk and paired with a concrete remediation path." },
    ],
    "healthtech": [
      { serviceName: "Healthcare Backend Engineering", slug: "backend-development", description: "HIPAA-compliant APIs and EHR integrations", applicationDetail: "FHIR R4 and HL7v2 integrations with Epic, Cerner, and Athenahealth, HIPAA-compliant data handling, audit logging, and the idempotency logic that keeps patient records consistent across systems." },
      { serviceName: "Clinical Interface Development", slug: "frontend-development", description: "Patient portals and clinical dashboards", applicationDetail: "Telehealth platforms, patient-facing portals, and clinician dashboards built WCAG AA compliant and optimised for users ranging from elderly patients on tablets to physicians between appointments." },
      { serviceName: "Patient & Clinician UX Design", slug: "ux-ui-design", description: "Accessible, health-literate interface design", applicationDetail: "UX research and design for healthcare audiences: plain-language content, accessible colour contrast, assistive technology compatibility, and the trust signals that make patients comfortable sharing sensitive data." },
      { serviceName: "HIPAA Cloud Architecture", slug: "cloud-consulting", description: "BAA-covered infrastructure with compliance built in", applicationDetail: "Cloud architecture where HIPAA controls are structural: encryption everywhere, access logging by default, BAA agreements with every subprocessor, and automated compliance evidence collection for auditors." },
    ],
    "edtech": [
      { serviceName: "Learning Platform Development", slug: "frontend-development", description: "LMS and course delivery interfaces", applicationDetail: "Course creation tools, progress dashboards, assessment engines, and adaptive learning interfaces that handle enrollment spikes and keep learners engaged across every lesson." },
      { serviceName: "Mobile Learning Apps", slug: "apps", description: "Offline-capable iOS and Android learning apps", applicationDetail: "Download-and-learn mobile experiences with offline video playback, progress sync when connectivity returns, and push notifications timed to reinforce daily learning habits." },
      { serviceName: "Learning Experience Design", slug: "ux-ui-design", description: "UX for educators, learners, and administrators", applicationDetail: "Separate interfaces for instructors who need fast content creation tools and students who need distraction-free learning flows — both tested with real users before a line of code is written." },
      { serviceName: "EdTech Backend Engineering", slug: "backend-development", description: "Content APIs, progress tracking, and assessment engines", applicationDetail: "Course content delivery APIs, learner progress data models, quiz and assessment logic, third-party LTI integrations, and FERPA-compliant data handling for student records." },
    ],
    "proptech": [
      { serviceName: "Property Platform Development", slug: "frontend-development", description: "Listing, search, and transaction interfaces", applicationDetail: "MLS-compliant property search with map-based browsing, saved searches, instant alerts, and listing detail pages engineered to convert browsers into leads." },
      { serviceName: "PropTech Backend Engineering", slug: "backend-development", description: "MLS integrations, transaction APIs, and geospatial logic", applicationDetail: "MLS data ingestion pipelines, multi-party transaction coordination APIs, digital closing workflows, and the geospatial query optimisation that returns results in under 200ms across millions of listings." },
      { serviceName: "Property Search UX Design", slug: "ux-ui-design", description: "Map-based interfaces and listing design", applicationDetail: "Draw-to-search map interfaces, instant filter patterns, and property card layouts designed around the browsing behaviours real estate searchers actually use — validated with user research, not assumptions." },
      { serviceName: "Geospatial Cloud Architecture", slug: "cloud-consulting", description: "High-performance infrastructure for location-based platforms", applicationDetail: "PostGIS indexing strategy, tile server architecture, CDN configuration, and the caching layers that keep geospatial queries fast and infrastructure costs predictable as your listing volume grows." },
    ],
    "legaltech": [
      { serviceName: "Legal Backend Engineering", slug: "backend-development", description: "Document automation, case management APIs, and contract logic", applicationDetail: "Template engines with conditional logic, jurisdiction detection, clause libraries, matter management APIs, time tracking, and billing integrations built for the workflows legal professionals actually follow." },
      { serviceName: "Legal Platform Development", slug: "frontend-development", description: "Case management and workflow interfaces", applicationDetail: "Matter management dashboards, document assembly flows, and billing interfaces designed for attorneys who bill in 6-minute increments — every screen justified against the cost of using it." },
      { serviceName: "Attorney-Facing UX Design", slug: "ux-ui-design", description: "High-efficiency interfaces for legal professionals", applicationDetail: "UX design for an audience where every extra click has a dollar cost. Keyboard-navigable workflows, contextual actions, and the information density that experienced legal users demand." },
      { serviceName: "Legal Data Security Audit", slug: "software-auditing", description: "Privilege-protected architecture and access control review", applicationDetail: "Full audit of data access controls, privilege boundaries, encryption implementation, and audit trail completeness — the security posture that law firms and enterprise legal buyers require before signing a contract." },
    ],
    "ai-startup": [
      { serviceName: "Generative AI Development", slug: "ai", description: "RAG pipelines, model orchestration, and inference APIs", applicationDetail: "Vector databases, embedding pipelines, retrieval ranking, prompt management, and the orchestration layer that coordinates context and model calls into reliable, measurable outputs your users can trust." },
      { serviceName: "AI & ML Engineering", slug: "ai-ml", description: "Model development, fine-tuning, and evaluation infrastructure", applicationDetail: "Custom model training, fine-tuning pipelines, golden dataset creation, automated quality scoring, and the regression detection that catches model degradation before your users do." },
      { serviceName: "AI Backend Infrastructure", slug: "backend-development", description: "APIs, vector databases, and inference backends", applicationDetail: "Production AI APIs with streaming support, vector database architecture, context management, rate limiting, and the backend systems that keep inference reliable and latency predictable at scale." },
      { serviceName: "AI Cloud Strategy", slug: "cloud-consulting", description: "GPU provisioning, inference cost, and model serving architecture", applicationDetail: "GPU instance strategy, managed vs self-hosted inference trade-offs, vector database selection, and the cloud architecture that keeps per-query costs predictable as your user base scales." },
    ],
    "logistics-tech": [
      { serviceName: "Logistics Backend Engineering", slug: "backend-development", description: "Fleet APIs, route optimisation, and real-time tracking logic", applicationDetail: "Fleet management APIs, route optimisation algorithms, proof-of-delivery systems, and the event processing backbone that handles sub-second location updates from thousands of vehicles simultaneously." },
      { serviceName: "Driver Mobile App", slug: "apps", description: "Offline-capable delivery and routing apps", applicationDetail: "Turn-by-turn navigation, delivery queue management, proof-of-delivery capture, and customer notifications that work offline in tunnels and basements — syncing seamlessly when connectivity returns." },
      { serviceName: "Dispatch Dashboard Development", slug: "frontend-development", description: "Real-time fleet visualisation and dispatch interfaces", applicationDetail: "Live fleet dashboards with vehicle status, driver assignment, route visualisation, and the exception management interfaces that dispatchers need to make decisions in seconds, not minutes." },
      { serviceName: "Real-Time Logistics Cloud", slug: "cloud-consulting", description: "Event streaming and GPS infrastructure at fleet scale", applicationDetail: "Event streaming architecture for high-frequency location data, time-series storage strategy, CDN for driver apps, and the infrastructure design that scales from 100 to 10,000 vehicles without re-architecting." },
    ],
    "ecommerce": [
      { serviceName: "Custom Storefront Development", slug: "website-development", description: "High-performance custom e-commerce websites", applicationDetail: "Bespoke Next.js storefronts with product catalogue, collections, search, and checkout built from scratch — no template ceiling on performance, design, or custom business logic." },
      { serviceName: "Commerce Backend Engineering", slug: "backend-development", description: "Inventory, order management, and payment APIs", applicationDetail: "Custom commerce APIs for inventory synchronisation across channels, order management, multi-warehouse fulfilment, discount logic, and Stripe or payment gateway integration that handles edge cases cleanly." },
      { serviceName: "Conversion-Optimised UX Design", slug: "ux-ui-design", description: "Checkout, product page, and browse experience design", applicationDetail: "Product pages, collection layouts, and checkout flows designed around the metrics that drive revenue: add-to-cart rate, checkout completion, and return visit rate — validated with real user data." },
      { serviceName: "Mobile Shopping App", slug: "apps", description: "Native iOS and Android commerce experiences", applicationDetail: "Mobile shopping apps with one-tap checkout, saved preferences, personalised recommendations, and push notifications timed to buying patterns that outperform mobile web conversion." },
    ],
    "b2b-saas": [
      { serviceName: "SaaS Backend Engineering", slug: "backend-development", description: "Multi-tenant platform, billing, SSO, and SCIM", applicationDetail: "Tenant isolation architecture, Stripe billing with usage metering, SAML/OIDC SSO, SCIM provisioning, audit logging, and the role-based access controls that unblock enterprise procurement." },
      { serviceName: "SaaS Product Development", slug: "frontend-development", description: "Dashboards, admin consoles, and self-serve onboarding", applicationDetail: "Core product UI, admin consoles, usage dashboards, and the self-serve onboarding flows that convert free trials to paid subscriptions without requiring sales intervention." },
      { serviceName: "SaaS UX Design", slug: "ux-ui-design", description: "Product, settings, and upgrade experience design", applicationDetail: "Application dashboards, settings panels, empty states, and upgrade prompts designed for B2B users who spend hours in your product — where friction has a direct cost in churn." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Technical leadership for enterprise sales and architecture", applicationDetail: "CTO-level guidance on multi-tenant architecture decisions, enterprise feature strategy, SOC 2 readiness, and the technical credibility that enterprise procurement and investor due diligence requires." },
    ],
    "consumer-apps": [
      { serviceName: "iOS & Android App Development", slug: "apps", description: "Native consumer mobile experiences", applicationDetail: "Polished mobile apps with gesture-driven navigation, smooth animations, offline caching, and the 60fps performance users expect from top-tier consumer apps." },
      { serviceName: "Consumer Backend Engineering", slug: "backend-development", description: "Real-time feeds, notifications, and social features backend", applicationDetail: "Backend services for activity feeds, user profiles, push notification pipelines, chat infrastructure, and the event-driven architecture that keeps real-time social features snappy at scale." },
      { serviceName: "Retention-Focused UX Design", slug: "ux-ui-design", description: "Onboarding, engagement, and retention UX", applicationDetail: "Onboarding flows, notification preference design, and social feature UX built around behavioural psychology and measured by Day-7 retention — not how good it looks in a design review." },
      { serviceName: "Consumer Web App Development", slug: "frontend-development", description: "Web companion and progressive web app", applicationDetail: "Web-based companion experiences that extend your mobile product to desktop users, with shared session state, feature parity on key flows, and performance optimised for web-first discovery." },
    ],
    // BY PRODUCT TYPE
    "web-app": [
      { serviceName: "Frontend Engineering", slug: "frontend-development", description: "React/Next.js application frontend", applicationDetail: "Component-driven React and Next.js frontend with server-side rendering, real-time UI features, and the clean architecture that lets your team ship new features without untangling existing ones." },
      { serviceName: "Backend Engineering", slug: "backend-development", description: "API, database, and business logic", applicationDetail: "RESTful or GraphQL API, database design, authentication, background jobs, WebSocket infrastructure for real-time features, and the server-side logic that powers your application." },
      { serviceName: "Application UX Design", slug: "ux-ui-design", description: "Dashboard and workflow interface design", applicationDetail: "Complex application interfaces — dashboards, settings panels, multi-step workflows — designed for daily use by power users who value speed and density over hand-holding." },
      { serviceName: "Deployment & DevOps", slug: "devops", description: "CI/CD, hosting, and production monitoring", applicationDetail: "Automated deployment pipelines, staging environments, database management, uptime monitoring, and the error tracking setup that means your team finds problems before users do." },
    ],
    "mobile-app": [
      { serviceName: "iOS & Android Development", slug: "apps", description: "Native and cross-platform mobile development", applicationDetail: "React Native for maximum code sharing across iOS and Android, or Swift and Kotlin when your app needs native-only capabilities like AR, HealthKit, advanced camera, or peak performance." },
      { serviceName: "Mobile Backend Engineering", slug: "backend-development", description: "Mobile API, push notifications, and offline sync", applicationDetail: "Mobile-optimised API design, push notification infrastructure for APNS and FCM, offline-first data sync with conflict resolution, and the backend architecture that keeps mobile apps fast on 4G." },
      { serviceName: "Mobile UX Design", slug: "ux-ui-design", description: "Touch-first interface and interaction design", applicationDetail: "Gesture-driven navigation, thumb-zone-aware layouts, micro-interactions, and the platform-specific patterns (iOS vs Android) that users expect without thinking — validated with real device testing." },
      { serviceName: "Mobile CI/CD & Store Delivery", slug: "devops", description: "Automated build pipelines and app store submission", applicationDetail: "Fastlane pipelines, TestFlight and Firebase distribution, automated screenshot generation, and release management that handles app store review processes without manual overhead." },
    ],
    "ai-product": [
      { serviceName: "Generative AI Development", slug: "ai", description: "RAG pipelines, model orchestration, and inference APIs", applicationDetail: "Vector databases, embedding pipelines, retrieval ranking, prompt management, and the orchestration layer that coordinates context and model calls into reliable, measurable outputs your users can trust." },
      { serviceName: "AI & ML Engineering", slug: "ai-ml", description: "Model development, fine-tuning, and evaluation infrastructure", applicationDetail: "Custom model training, fine-tuning pipelines, golden dataset creation, automated quality scoring, and the regression detection that catches model degradation before your users experience it." },
      { serviceName: "AI Backend Infrastructure", slug: "backend-development", description: "APIs, vector databases, and inference backend", applicationDetail: "Production AI APIs with streaming support, vector database architecture, context window management, rate limiting, and the backend systems that keep inference reliable and latency predictable at scale." },
      { serviceName: "Human-AI Interaction Design", slug: "ux-ui-design", description: "AI product UX and trust pattern design", applicationDetail: "Designing where to show confidence scores, how to present sources, where to surface corrections, and how to make generation latency feel acceptable — the UX layer that determines whether users trust your AI." },
    ],
    "saas-platform": [
      { serviceName: "SaaS Backend Engineering", slug: "backend-development", description: "Multi-tenant core, billing, and subscription logic", applicationDetail: "Tenant isolation architecture, Stripe or Chargebee billing with usage metering and dunning, SAML/OIDC SSO, SCIM provisioning, and the subscription enforcement layer that gates features by plan across your entire platform." },
      { serviceName: "SaaS Product Development", slug: "frontend-development", description: "Dashboards, admin consoles, and onboarding flows", applicationDetail: "Core product UI, admin consoles, usage dashboards, and self-serve onboarding flows that convert free trials to paid subscriptions without requiring sales to intervene." },
      { serviceName: "SaaS UX Design", slug: "ux-ui-design", description: "Product, onboarding, and upgrade experience design", applicationDetail: "Application dashboards, settings panels, empty states, and upgrade prompts designed to convert free users to paid without feeling pushy — and to reduce churn by making the product feel effortless to use." },
      { serviceName: "Multi-Tenant Cloud Architecture", slug: "cloud-consulting", description: "SaaS infrastructure strategy and tenant operations", applicationDetail: "Tenant isolation at the infrastructure level, per-tenant resource limits, SOC 2 logging configuration, feature flags per plan, and the cloud architecture that enterprise procurement teams need to see before signing." },
    ],
    "marketplace": [
      { serviceName: "Marketplace Backend Engineering", slug: "backend-development", description: "Payments, matching logic, and marketplace APIs", applicationDetail: "Stripe Connect with escrow, split payments, and seller payouts; buyer-seller matching algorithms; listing management APIs; dispute resolution workflows; and the accounting reconciliation that keeps every transaction traceable." },
      { serviceName: "Marketplace Platform Development", slug: "frontend-development", description: "Buyer and seller interfaces, search, and listings", applicationDetail: "Separate buyer and seller experiences, listing creation flows, search and discovery, transaction progress tracking, and the review and rating interfaces that build trust between strangers." },
      { serviceName: "Marketplace UX Design", slug: "ux-ui-design", description: "Trust-building UX for two-sided markets", applicationDetail: "Search result layouts, listing creation flows, transaction progress indicators, and the review and rating systems designed to build the trust that makes strangers willing to transact with each other." },
      { serviceName: "Marketplace Mobile App", slug: "apps", description: "Native iOS and Android marketplace app", applicationDetail: "Mobile marketplace experience with listing browsing, in-app messaging, push notifications for offers and transactions, and the one-tap checkout flow that drives higher conversion than mobile web." },
    ],
    "api-product": [
      { serviceName: "API Backend Engineering", slug: "backend-development", description: "RESTful and GraphQL API architecture", applicationDetail: "Endpoint design, API key and OAuth authentication, pagination, filtering, versioning strategy, and the consistent error handling that makes your API predictable and a pleasure for developers to integrate." },
      { serviceName: "Developer Portal Development", slug: "frontend-development", description: "Documentation site, sandbox, and developer dashboard", applicationDetail: "Interactive API documentation, code samples in multiple languages, sandbox environments, and the developer dashboard where users manage API keys, monitor usage, and read changelogs." },
      { serviceName: "API Infrastructure Strategy", slug: "cloud-consulting", description: "Gateway, rate limiting, and scaling architecture", applicationDetail: "API gateway configuration, rate limiting tiers, global CDN distribution, request logging, and the cloud architecture that keeps p99 latency low as your developer customer base grows." },
      { serviceName: "API Security Audit", slug: "software-auditing", description: "Security assessment and vulnerability review", applicationDetail: "Authentication implementation review, authorisation boundary testing, input validation audit, dependency scanning, and the security assessment that enterprise customers require before integrating your API." },
    ],
    "data-platform": [
      { serviceName: "Pipeline Development", slug: "backend-development", description: "ELT pipeline architecture and implementation", applicationDetail: "Extractors for any source (APIs, databases, files, event streams), dbt transformations with proper testing, and orchestration that recovers from failures automatically." },
      ...
      { serviceName: "Data Infrastructure", slug: "backend-development", description: "Warehouse, orchestration, and monitoring", applicationDetail: "Snowflake/BigQuery/Redshift configuration, Airflow or Dagster orchestration, and the monitoring that alerts when data is stale, missing, or anomalous." },
    ],
    "iot": [
      { serviceName: "IoT Platform Development", slug: "frontend-development", description: "Device management and fleet operations", applicationDetail: "Fleet dashboards, device status monitoring, remote configuration, and the grouping/segmentation tools that make managing thousands of devices practical." },
      ...
      { serviceName: "IoT Infrastructure", slug: "backend-development", description: "MQTT brokers, time-series storage, and edge computing", applicationDetail: "MQTT broker clusters (EMQX, HiveMQ), TimescaleDB or InfluxDB for telemetry, and the edge computing layer that processes data locally when latency matters." },
    ],
    "internal-tools": [
      { serviceName: "Custom Tool Development", slug: "frontend-development", description: "Bespoke operations software", applicationDetail: "Admin panels, approval workflows, data entry interfaces, and the dashboards that replace the spreadsheets your operations team is maintaining in secret." },
    ...
    "embedded": [
      { serviceName: "Firmware Engineering", slug: "apps", description: "Application and system firmware", applicationDetail: "Bare-metal or RTOS-based firmware with clean architecture: HAL layer, application logic, and communication stack separated for maintainability and hardware portability." },
      { serviceName: "Cloud Backend", slug: "backend-development", description: "Device cloud and management platform", applicationDetail: "Web dashboards for fleet management, firmware distribution systems, telemetry collection, and the APIs that mobile companion apps use to interact with devices." },
      ...
      { serviceName: "Embedded DevOps", slug: "software-auditing", description: "CI/CD for firmware and OTA delivery", applicationDetail: "Hardware-in-the-loop testing, automated firmware builds, OTA delivery infrastructure, and the staged rollout system that validates updates before full fleet deployment." },
    ],
    // BY STAGE
    "pre-idea": [
      { serviceName: "Pre-Launch Brand Identity", slug: "startup-branding", description: "Visual credibility before your product exists", applicationDetail: "Logo, colour system, and pitch deck design that makes investors take your concept seriously before a line of code exists — because first impressions happen before demos." },
      { serviceName: "Concept Design & Prototyping", slug: "ux-ui-design", description: "Early UX validation and concept visualisation", applicationDetail: "Clickable prototypes that communicate your product vision to investors and early users, built fast enough to test assumptions before committing to engineering." },
      { serviceName: "Early Infrastructure Planning", slug: "cloud-consulting", description: "Cloud strategy before you start building", applicationDetail: "Provider selection, architecture approach, and the infrastructure decisions that are cheapest to make before writing code and most expensive to undo six months in." },
      { serviceName: "Proof-of-Concept Development", slug: "frontend-development", description: "Working prototype to validate your core idea", applicationDetail: "A functional prototype that demonstrates your concept to investors and early adopters — scoped ruthlessly to the one interaction that proves your hypothesis." },
    ],
    "validation": [
      { serviceName: "Validation-Stage Brand Design", slug: "startup-branding", description: "Brand credibility for user testing", applicationDetail: "Brand identity polished enough that test users engage with your product as real, not as a student project — because honest feedback requires users to suspend disbelief." },
      { serviceName: "User Testing & Prototype Design", slug: "ux-ui-design", description: "Prototype design for structured user validation", applicationDetail: "High-fidelity prototypes built for structured user testing sessions, with interaction design that surfaces real usability problems before any production code is written." },
      { serviceName: "Validation Frontend Build", slug: "frontend-development", description: "Lightweight build to test with real users", applicationDetail: "A functional but scoped build that lets real users interact with your product, generating behavioural data that clickable prototypes alone cannot produce." },
      { serviceName: "Validation Infrastructure", slug: "cloud-consulting", description: "Minimal cloud setup for testing, not production", applicationDetail: "Infrastructure configured for speed and cost during validation: fast deploys, easy resets, and hosting costs that fit a pre-revenue budget while keeping your architecture production-compatible." },
    ],
    "mvp": [
      { serviceName: "MVP Frontend Development", slug: "frontend-development", description: "Core user flows built to production quality", applicationDetail: "The minimum feature set that tests your core hypothesis, built with clean architecture so what you ship to early users becomes the foundation you scale — not the thing you rewrite." },
      { serviceName: "MVP Backend Engineering", slug: "backend-development", description: "API, database, and business logic for launch", applicationDetail: "Authentication, core data models, essential APIs, and the business logic that powers your MVP — engineered to production standard from day one so you are scaling, not rebuilding." },
      { serviceName: "MVP UX Design", slug: "ux-ui-design", description: "User-tested design before engineering begins", applicationDetail: "Wireframes and high-fidelity prototypes validated with real users before a line of production code is written, so engineering effort goes into flows that actually work." },
      { serviceName: "MVP Launch Infrastructure", slug: "devops", description: "CI/CD and hosting operational from day one", applicationDetail: "Deployment pipeline, hosting, monitoring, and error tracking configured before feature work begins — so your first production deploy is not also your first time touching infrastructure." },
    ],
    "early-traction": [
      { serviceName: "Growth Backend Engineering", slug: "backend-development", description: "Scaling backend for your first growth spike", applicationDetail: "Database optimisation, connection pooling, caching layers, and API performance improvements that keep your product stable as user count multiplies faster than you planned for." },
      { serviceName: "Feature Development", slug: "frontend-development", description: "Rapid feature iteration driven by user data", applicationDetail: "New features and product improvements shipped in short cycles, informed by the usage data you are now collecting from real users who are actively engaging with your product." },
      { serviceName: "Growth Infrastructure", slug: "devops", description: "Deployment pipeline and monitoring for a growing product", applicationDetail: "CI/CD pipelines, staging environments, uptime monitoring, and the alerting setup that lets you ship multiple times a week without fear and catch problems before users report them." },
      { serviceName: "Mobile App Development", slug: "apps", description: "iOS and Android app if not yet built", applicationDetail: "Cross-platform mobile app that extends your product to users who live on their phones — built on the same backend you already have, with the native performance early traction users expect." },
    ],
    "seed-stage": [
      { serviceName: "Core Product Development", slug: "frontend-development", description: "Product build funded by your seed round", applicationDetail: "Full product development with senior engineers: clean architecture, proper testing, and the engineering quality that holds up when investors commission technical due diligence." },
      { serviceName: "Seed-Stage Backend Engineering", slug: "backend-development", description: "APIs, database, and platform built to scale", applicationDetail: "Backend architecture designed for the next 18 months of growth: scalable data models, clean API contracts, authentication, and the foundation that your Series A engineering team can build on." },
      { serviceName: "Investor-Grade Brand Identity", slug: "startup-branding", description: "Brand that signals professionalism to seed investors", applicationDetail: "Logo, brand guidelines, and pitch deck design that make your startup look established and intentional — the visual credibility that affects how seriously investors take your product." },
      { serviceName: "Seed-Stage Cloud Strategy", slug: "cloud-consulting", description: "Cloud architecture for your next 12 months of growth", applicationDetail: "Infrastructure designed for seed-stage economics: right-sized for current scale with a documented path to grow, and architected well enough to pass the technical review that comes with your next funding round." },
    ],
    "growth": [
      { serviceName: "Platform Scaling Engineering", slug: "backend-development", description: "Scaling systems for compounding user growth", applicationDetail: "Database scaling strategy, caching layers, read replicas, background job architecture, and the engineering improvements that let your platform handle 10x users without an emergency re-architecture." },
      { serviceName: "Dedicated Engineering Team", slug: "dedicated-teams", description: "Embedded senior engineers for sustained delivery", applicationDetail: "2-8 senior engineers attending your standups, shipping features continuously, and accumulating the codebase context that makes velocity compound month over month." },
      { serviceName: "Growth Infrastructure", slug: "devops", description: "Deployment, monitoring, and reliability for scale", applicationDetail: "Auto-scaling configuration, advanced monitoring, incident response runbooks, and the deployment confidence that lets a growing engineering team ship daily without fear." },
      { serviceName: "Growth Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure strategy for compounding scale", applicationDetail: "Proactive capacity planning, multi-region readiness assessment, cost optimisation, and the cloud architecture decisions that prevent your infrastructure from becoming a growth bottleneck." },
    ],
    "scale-up": [
      { serviceName: "Dedicated Engineering Teams", slug: "dedicated-teams", description: "Multiple embedded teams for enterprise-scale delivery", applicationDetail: "Senior engineering squads embedded across your product areas, operating with the autonomy and context of internal teams while delivering the velocity your scale-up roadmap demands." },
      { serviceName: "Enterprise Platform Engineering", slug: "backend-development", description: "Enterprise-scale backend architecture", applicationDetail: "Distributed systems design, horizontal scaling architecture, database sharding strategy, and the platform engineering that supports dozens of engineers shipping independently without stepping on each other." },
      { serviceName: "Enterprise Cloud Architecture", slug: "cloud-consulting", description: "Multi-region, enterprise-grade infrastructure strategy", applicationDetail: "Multi-region active-active architecture, disaster recovery planning, data residency compliance, SLA enforcement infrastructure, and the cloud strategy that enterprise customers require before signing." },
      { serviceName: "Architecture & Code Quality Audit", slug: "software-auditing", description: "Full codebase and architecture review at scale", applicationDetail: "Comprehensive audit of architecture sustainability, technical debt prioritisation, security posture, and the engineering practices that need to evolve as your team grows from 10 to 100 engineers." },
    ],
    // BY FOUNDER TYPE
    "non-technical-founder": [
      { serviceName: "Full Product Development", slug: "frontend-development", description: "End-to-end frontend build with all decisions owned", applicationDetail: "We handle framework selection, architecture, and implementation. You handle business decisions. Every update is explained in plain language — no CS degree required to follow along." },
      { serviceName: "Backend & API Development", slug: "backend-development", description: "Server-side systems explained without jargon", applicationDetail: "Database design, API development, authentication, and integrations — all handled and explained in business terms so you understand what was built and why, without needing to read the code." },
      { serviceName: "User-Tested UX Design", slug: "ux-ui-design", description: "Design validated with real users before building", applicationDetail: "We design and test with your target users before writing a line of production code. You approve a working prototype, not a static mockup — so engineering effort goes into flows that actually work." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Technical leadership without a technical background", applicationDetail: "Architecture decisions, technology selection, hiring guidance, and the strategic technical direction that non-technical founders need most — explained in business terms, never in jargon." },
    ],
    "first-time-founder": [
      { serviceName: "MVP Development", slug: "frontend-development", description: "Lean first product built to production quality", applicationDetail: "The minimum feature set that tests your core hypothesis, built with clean architecture so what you ship to early users becomes the foundation you scale — not the prototype you throw away." },
      { serviceName: "Backend & API Development", slug: "backend-development", description: "Backend systems with technical guidance included", applicationDetail: "Database design, API development, authentication, and the architecture decisions you have not faced before — all explained so you finish the engagement understanding your own product." },
      { serviceName: "User-Centred Product Design", slug: "ux-ui-design", description: "Design validated before engineering begins", applicationDetail: "We test assumptions with prototypes before building features. User interviews, usability sessions, and the data that tells you what to build next — so your first product solves a real problem." },
      { serviceName: "First-Startup Brand Identity", slug: "startup-branding", description: "Professional brand that makes you look established", applicationDetail: "Logo, colour palette, typography, and brand guidelines that make your startup look intentional from day one — the visual credibility that opens doors with early customers and investors." },
    ],
    "solo-founder": [
      { serviceName: "Full Project Outsourcing", slug: "outsourcing", description: "End-to-end delivery without daily management", applicationDetail: "We own architecture, development, testing, and deployment. You approve direction weekly and review working software at milestones. No daily standups, no engineering management required from you." },
      { serviceName: "Backend Development", slug: "backend-development", description: "Backend systems built and run autonomously", applicationDetail: "Database design, API development, authentication, integrations, and server-side logic — all delivered and documented so your product runs reliably without you understanding the internals." },
      { serviceName: "Frontend Development", slug: "frontend-development", description: "Frontend delivered without your daily input", applicationDetail: "UI development, component architecture, and product interfaces delivered autonomously. You approve designs and review working software. No pixel-level feedback sessions required." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Senior technical leadership for a company of one", applicationDetail: "Architecture decisions, technology selection, and the strategic technical direction a solo founder needs to avoid expensive mistakes — without the cost or commitment of a full-time CTO hire." },
    ],
    "repeat-founder": [
      { serviceName: "Dedicated Senior Engineering Team", slug: "dedicated-teams", description: "Engineers who match your technical standards", applicationDetail: "Senior engineers embedded in your workflow who write code you would be proud to show during technical due diligence — daily commits, weekly milestones, no hand-holding required." },
      { serviceName: "Backend Architecture & Development", slug: "backend-development", description: "Architecture-first backend engineering", applicationDetail: "Clean architecture, proper data modelling, meaningful code review, and the engineering rigour that produces a codebase your future team can maintain without you in the room." },
      { serviceName: "Frontend Engineering", slug: "frontend-development", description: "High-quality frontend at velocity", applicationDetail: "Component-driven React development with proper testing, accessibility, and performance built in — not bolted on after the fact. The frontend quality standard experienced founders recognise immediately." },
      { serviceName: "Architecture & Code Review", slug: "software-auditing", description: "Independent validation of technical direction", applicationDetail: "Second opinions on architectural decisions, stack selection, and scaling strategy from engineers who have taken 50+ projects to production and can tell you what breaks at scale." },
    ],
    "student-startup": [
      { serviceName: "Demo Day MVP", slug: "frontend-development", description: "Working product scoped to your deadline", applicationDetail: "A real product — not a prototype — that demonstrates your concept, handles real users, and impresses judges and investors. Scoped to your deadline and delivered before it." },
      { serviceName: "Backend Development", slug: "backend-development", description: "Backend with every decision explained", applicationDetail: "Database design, API development, and authentication — all built and documented so you understand your own product well enough to answer any technical question an investor throws at you." },
      { serviceName: "Pitch-Ready UX Design", slug: "ux-ui-design", description: "Polished UI that makes your product look funded", applicationDetail: "Clean, professional interface design that makes your product look like it has a full design team behind it. First impressions at demo day happen in seconds — yours should be flawless." },
      { serviceName: "Student Startup Brand Identity", slug: "startup-branding", description: "Professional brand on a student budget", applicationDetail: "Logo, colour palette, and brand guidelines that make your startup look intentional and established — the visual credibility that separates serious teams from side projects at demo day." },
    ],
    "corporate-innovator": [
      { serviceName: "Dedicated Engineering Team", slug: "dedicated-teams", description: "Enterprise-grade engineers embedded in your workflow", applicationDetail: "Senior engineers delivering at startup speed with the documentation, security controls, and audit trail that enterprise governance requires — without the compliance shortcuts that create problems later." },
      { serviceName: "Legacy System Integration", slug: "backend-development", description: "Connecting new products to existing enterprise systems", applicationDetail: "SAP, Salesforce, Oracle, and custom internal API integrations built with proper error handling, data mapping, and the resilience that enterprise workloads demand when legacy systems behave unpredictably." },
      { serviceName: "Enterprise Product Development", slug: "frontend-development", description: "Innovation that aligns with corporate design systems", applicationDetail: "Fresh product development that respects corporate brand guidelines, accessibility standards, and the internal design system your organisation maintains — moving fast without creating visual debt." },
      { serviceName: "Enterprise Security Audit", slug: "software-auditing", description: "Compliance review and security posture assessment", applicationDetail: "Full codebase and infrastructure review against your organisation's security requirements, InfoSec team standards, and any applicable compliance frameworks before the product goes anywhere near production." },
    ],
    "female-led": [
      { serviceName: "Full Product Development", slug: "frontend-development", description: "Engineering partnership on equal terms", applicationDetail: "Complete frontend development with transparent pricing, senior engineers, and communication that treats your expertise with the same respect you bring to every business decision." },
      { serviceName: "Backend & Technical Strategy", slug: "backend-development", description: "Architecture decisions delivered peer-to-peer", applicationDetail: "Backend development, architecture decisions, and scaling strategy presented as peer-to-peer discussion — options, tradeoffs, and recommendations, not top-down technical lectures." },
      { serviceName: "Collaborative UX Design", slug: "ux-ui-design", description: "Design process that treats your input as equal", applicationDetail: "Your product vision and domain knowledge inform every design decision. We bring UX expertise. You bring market expertise. Both are weighted equally in every design review." },
      { serviceName: "Founder Brand Identity", slug: "startup-branding", description: "Brand built around your vision, not assumptions", applicationDetail: "Logo, colour system, and brand guidelines developed through genuine collaboration — your vision drives the direction, our craft executes it, and the result is entirely yours." },
    ],
    "african-startup": [
      { serviceName: "African Market Web Development", slug: "frontend-development", description: "Web products built for real African infrastructure", applicationDetail: "Web applications optimised for low bandwidth, intermittent connectivity, and the mid-range Android device landscape your actual users have — not the high-end devices your team uses to build." },
      { serviceName: "Mobile & Payment Integration", slug: "apps", description: "Mobile apps with African payment rail support", applicationDetail: "Mobile applications with M-Pesa, Paystack, and Flutterwave integration, offline-first data sync, and the USSD fallback patterns that keep your product accessible when data is expensive." },
      { serviceName: "African Payments Backend", slug: "backend-development", description: "M-Pesa, Paystack, Flutterwave, and mobile money APIs", applicationDetail: "Backend payment integrations for the rails your users actually use: mobile money, bank transfer, and USSD payment — with proper reconciliation, failure handling, and settlement logic for each." },
      { serviceName: "Africa-Optimised Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure built for African market economics", applicationDetail: "CDN endpoints near African users, edge caching for low-bandwidth environments, data localisation for countries that require it, and hosting costs calibrated to your market's revenue economics." },
    ],
    "diaspora-founder": [
      { serviceName: "Multi-Market Backend Engineering", slug: "backend-development", description: "Cross-border payments, multi-currency, and compliance APIs", applicationDetail: "Payment infrastructure for cross-border transactions: currency conversion, settlement logic, regulatory reporting, and the multi-currency data model that handles two markets without maintaining two codebases." },
      { serviceName: "Multi-Market Platform Development", slug: "frontend-development", description: "Multi-language, multi-currency product interfaces", applicationDetail: "Product UI built for multiple markets simultaneously: i18n architecture, RTL layout support where needed, currency formatting, and the localisation infrastructure that lets you ship to both markets from one codebase." },
      { serviceName: "Mobile App Development", slug: "apps", description: "Mobile-first apps for global diaspora audiences", applicationDetail: "Mobile apps optimised for the connectivity and device landscape of both your origin and destination markets — with offline capability, local payment methods, and the performance that mobile-first users expect." },
      { serviceName: "Multi-Region Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure serving two markets with low latency", applicationDetail: "Multi-region deployment strategy, data residency compliance per country, cross-border latency optimisation, and the cloud architecture that gives users in both markets a fast, compliant experience." },
    ],
    "social-enterprise": [
      { serviceName: "Impact-Focused Product Development", slug: "frontend-development", description: "Technology built to maximise social outcome", applicationDetail: "Features prioritised by impact per development dollar, not technical interest. Every sprint delivers something that moves your mission forward and can be reported to funders as concrete progress." },
      { serviceName: "Accessible Backend Engineering", slug: "backend-development", description: "Compliant, inclusive backend systems", applicationDetail: "WCAG-compatible data serving, accessible API design, GDPR and data protection compliance, and the backend architecture that handles the diverse user base social enterprises actually serve." },
      { serviceName: "Inclusive UX Design", slug: "ux-ui-design", description: "Design validated with the people you actually serve", applicationDetail: "User research that includes people with disabilities, older adults, and users with limited digital literacy — then design validated with those same people, not assumed to work for them." },
      { serviceName: "Mission-Aligned Brand Identity", slug: "startup-branding", description: "Brand that communicates your values and builds trust", applicationDetail: "Visual identity that reflects your mission, builds trust with the communities you serve, and presents your organisation as credible to funders, partners, and the people relying on your work." },
    ],
    // BY CHALLENGE
    "fast-mvp": [
      { serviceName: "Rapid Frontend Development", slug: "frontend-development", description: "MVP frontend shipped in 4-6 weeks", applicationDetail: "Scope defined on Monday, features shipping every two weeks. We cut scope ruthlessly to the 3-5 interactions that validate your core hypothesis and build those to production quality — nothing else." },
      { serviceName: "Rapid Backend Development", slug: "backend-development", description: "Lean backend built for speed without fragility", applicationDetail: "Authentication, core data models, and essential APIs built lean but properly — so your MVP handles real users from day one without the emergency rewrites that fragile MVPs always require." },
      { serviceName: "Speed-Optimised UX Design", slug: "ux-ui-design", description: "Design that looks great without slowing delivery", applicationDetail: "Design system selection over custom design, proven UX patterns over novel interactions, and the minimal interface work that makes your MVP look professional without adding weeks to the timeline." },
      { serviceName: "Launch Infrastructure", slug: "devops", description: "CI/CD and hosting operational from day one", applicationDetail: "Vercel or AWS with deployment pipeline configured before feature work begins. Every commit deploys to staging automatically. Production ships with a button click when you are ready." },
    ],
    "scaling-tech": [
      { serviceName: "Performance & Scaling Audit", slug: "software-auditing", description: "Full-stack bottleneck identification", applicationDetail: "Database query profiling, API response time analysis, frontend rendering measurement, and infrastructure utilisation tracking. Find the real constraint before spending a day fixing the wrong thing." },
      { serviceName: "Architecture Remediation", slug: "backend-development", description: "Targeted fixes for scaling bottlenecks", applicationDetail: "Database indexing, query optimisation, caching layers, connection pooling, read replicas, and the targeted backend interventions that resolve 80% of performance issues without a full rewrite." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Senior technical leadership for scaling decisions", applicationDetail: "Architecture direction, technology decisions, and the experienced judgment that tells you which scaling problems to solve now and which to defer — from someone who has navigated this inflection point before." },
      { serviceName: "Deployment Modernisation", slug: "devops", description: "CI/CD, feature flags, and deployment confidence", applicationDetail: "Automated testing, staging environments, feature flags, and rollback capability — the deployment infrastructure that lets your team ship daily without fear and catch regressions before users do." },
    ],
    "agency-rescue": [
      { serviceName: "Codebase Assessment", slug: "software-auditing", description: "Honest evaluation of what your previous agency built", applicationDetail: "Complete codebase review scoring security vulnerabilities, architecture quality, test coverage, and documentation state. Written report with clear salvage-vs-replace recommendations and effort estimates for each path." },
      { serviceName: "Stabilisation & Rebuild", slug: "backend-development", description: "Critical fixes and backend recovery", applicationDetail: "Security patches, crash-causing bugs, and data-loss risks addressed immediately. Backend stabilised and documented before any forward development begins — so you know what you are building on." },
      { serviceName: "Frontend Recovery Development", slug: "frontend-development", description: "Recovering and rebuilding the frontend", applicationDetail: "Pragmatic frontend recovery: keep what works, replace what does not, add proper component structure, and restore the development velocity that the previous agency's shortcuts destroyed." },
      { serviceName: "CI/CD & Deployment Restoration", slug: "devops", description: "Deployment pipeline and monitoring rebuilt", applicationDetail: "Deployment pipeline, staging environment, monitoring, and error tracking restored or built from scratch — so your team can ship confidently and catch problems before users report them." },
    ],
    "fundraising-ready": [
      { serviceName: "Technical Due Diligence Prep", slug: "software-auditing", description: "Architecture documentation and codebase review", applicationDetail: "System architecture diagrams, technology rationale, scaling strategy, and technical roadmap prepared for experienced CTOs and technical investors — the people who will tear your stack apart before writing a cheque." },
      { serviceName: "Security Hardening", slug: "backend-development", description: "Vulnerability remediation before investor scrutiny", applicationDetail: "Dependency updates, vulnerability patches, encryption verification, access control audit, and the security posture that survives an investor-commissioned technical review without embarrassing findings." },
      { serviceName: "Investor-Ready Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure strategy documented for due diligence", applicationDetail: "Cloud architecture documentation, cost analysis, scaling roadmap, and the infrastructure narrative that answers the technical questions serious investors ask before committing capital." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Named technical leader for investor meetings and due diligence", applicationDetail: "A credible, experienced technical leader who presents your roadmap to investors, answers hard due diligence questions, and gives your raise the technical authority that founders without a CTO struggle to project." },
    ],
    "ai-integration": [
      { serviceName: "AI Feature Development", slug: "ai", description: "RAG pipelines and generative AI features", applicationDetail: "Complete AI feature implementation: retrieval infrastructure, model orchestration, streaming responses, prompt management, and the production implementation that makes AI feel reliable rather than experimental." },
      { serviceName: "AI & ML Infrastructure", slug: "ai-ml", description: "Eval pipelines and quality monitoring", applicationDetail: "Golden dataset creation, automated quality scoring, regression detection, and the A/B testing infrastructure that tells you whether AI changes actually help your users or quietly make things worse." },
      { serviceName: "AI Backend Integration", slug: "backend-development", description: "Vector databases, APIs, and inference backend", applicationDetail: "Vector database architecture, embedding pipeline setup, AI API integration with streaming support, context management, and the backend layer that keeps your AI features fast and costs predictable at scale." },
      { serviceName: "AI UX Design", slug: "ux-ui-design", description: "Human-AI interaction and trust pattern design", applicationDetail: "Confidence indicators, source citations, loading states, error messages, and the interaction design that sets correct user expectations for what your AI can and cannot do." },
    ],
    "tech-debt": [
      { serviceName: "Technical Debt Audit", slug: "software-auditing", description: "Full codebase analysis and debt prioritisation", applicationDetail: "Every piece of technical debt scored by velocity impact and reliability risk. A prioritised remediation plan that fixes the highest-impact debt first — not just the most obvious or most recent." },
      { serviceName: "Backend Modernisation", slug: "backend-development", description: "Incremental backend refactoring and cleanup", applicationDetail: "Strangler fig refactoring of problematic backend modules: replaced one at a time with clean implementations while feature development continues in parallel. No velocity freeze required." },
      { serviceName: "Frontend Modernisation", slug: "frontend-development", description: "Component cleanup and frontend debt reduction", applicationDetail: "Legacy component refactoring, design system consolidation, dependency upgrades, and the frontend cleanup that stops new features from inheriting old problems." },
      { serviceName: "DevOps Remediation", slug: "devops", description: "CI/CD and deployment pipeline restoration", applicationDetail: "CI/CD pipelines, automated quality gates, staging environments, and the monitoring infrastructure that catches problems before users report them — often the first debt that pays back immediately." },
    ],
    "security-compliance": [
      { serviceName: "Security Engineering", slug: "software-auditing", description: "Controls implementation as code", applicationDetail: "Encryption enforcement, access logging, MFA requirements, and network segmentation implemented at the infrastructure level. Automated, auditable, continuous." },
      ...
      { serviceName: "Gap Assessment", slug: "software-auditing", description: "Framework-specific posture analysis", applicationDetail: "Current state mapped against SOC 2, HIPAA, PCI-DSS, or GDPR requirements. Gap list with prioritized remediation plan and effort estimates per item." },
      { serviceName: "Audit Preparation", slug: "software-auditing", description: "Penetration testing and documentation", applicationDetail: "Penetration tests executed, remediation completed, documentation packaged, and questionnaire responses prepared. Your auditor receives a complete, organized evidence package." },
    ],
    "post-pivot": [
      { serviceName: "Codebase Triage & Salvage Audit", slug: "software-auditing", description: "Honest assessment of what transfers to your new direction", applicationDetail: "Every module evaluated for applicability to the pivoted direction. Clear keep, modify, or discard recommendation for each component — delivered in 1-2 weeks with effort estimates so you can make an informed decision." },
      { serviceName: "Pivot Backend Rebuild", slug: "backend-development", description: "Rapid backend rebuild for the new direction", applicationDetail: "Surgical modifications to existing backend logic plus new components for the pivoted direction. Maximum reuse of what still applies, clean replacement of what does not. Ship the new direction in 6-8 weeks." },
      { serviceName: "New Direction Frontend", slug: "frontend-development", description: "Frontend rebuilt for the pivoted product", applicationDetail: "New user flows and interfaces for the pivoted direction, reusing your existing design system and component library where it still applies — so you ship fast without starting from a blank canvas." },
      { serviceName: "Pivot UX Design", slug: "ux-ui-design", description: "UX design for your new product direction", applicationDetail: "Interface design for the pivoted product: fast iteration on new user flows, validated with users before building, while reusing the visual design system from the previous version where it still fits." },
    ],
    "no-tech-team": [
      { serviceName: "Full Project Outsourcing", slug: "outsourcing", description: "End-to-end delivery without an internal tech team", applicationDetail: "We own architecture, development, testing, and deployment from requirements to launch. You review working software at milestones. No hiring, no technical management, no gaps between engineering roles." },
      { serviceName: "Dedicated Engineering Team", slug: "dedicated-teams", description: "Your engineering team, embedded and managed", applicationDetail: "A dedicated team of senior engineers who attend your standups, ship features continuously, and give you the internal engineering capability you need without the overhead of hiring and managing it yourself." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Technical leadership when you have no tech team", applicationDetail: "Architecture decisions, technology selection, vendor evaluation, and the strategic technical direction your business needs — handled by an experienced technical leader without the cost of a full-time CTO hire." },
      { serviceName: "Frontend Development", slug: "frontend-development", description: "Frontend built and owned end-to-end", applicationDetail: "Complete frontend development handled independently — architecture, implementation, testing, and deployment. You approve direction and review working software. No technical input required from you." },
    ],
    "africa-launch": [
      { serviceName: "African Market Web Development", slug: "frontend-development", description: "Low-bandwidth optimised product for African infrastructure", applicationDetail: "Web product adaptation for 2G/3G connectivity, progressive loading, offline-first patterns, and the mid-range Android device landscape of your target African markets — not the high-end devices your team uses." },
      { serviceName: "Mobile App with African Payments", slug: "apps", description: "Mobile app with M-Pesa, Paystack, and Flutterwave", applicationDetail: "Mobile application built for African device and connectivity realities, with M-Pesa, Paystack, Flutterwave, and USSD payment integration — the rails your African users actually have access to." },
      { serviceName: "African Payment Rails Backend", slug: "backend-development", description: "Backend integration for African payment infrastructure", applicationDetail: "Server-side integration with African payment processors, mobile money APIs, bank transfer rails, and the reconciliation and settlement logic each requires — including the edge cases that only appear in production." },
      { serviceName: "Africa-Optimised Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure strategy for African market entry", applicationDetail: "CDN endpoints near African users, edge caching for constrained networks, data localisation for markets that require it, and hosting economics calibrated to the revenue potential of your African market." },
    ],
    // BY ENGAGEMENT
    "fixed-price-mvp": [
      { serviceName: "Fixed-Price Frontend Delivery", slug: "frontend-development", description: "Frontend scoped, priced, and delivered to a fixed contract", applicationDetail: "Scope defined, price locked, timeline agreed. Frontend development proceeds with milestone payments on working software. No hourly billing, no surprise invoices at the end of the month." },
      { serviceName: "Fixed-Price Backend Delivery", slug: "backend-development", description: "Backend scoped, priced, and delivered to a fixed contract", applicationDetail: "API, database, and business logic delivered against a detailed specification with acceptance criteria. Fixed price quoted against that scope. Changes require mutual agreement — no scope creep, no surprises." },
      { serviceName: "MVP UX Design", slug: "ux-ui-design", description: "Lean design delivered within fixed scope", applicationDetail: "Design system selection, key screen layouts, and the minimal UX work that makes your MVP look professional and tested — without adding weeks to the timeline or scope to the contract." },
      { serviceName: "Launch Infrastructure", slug: "devops", description: "CI/CD and hosting included in the fixed price", applicationDetail: "Deployment pipeline, hosting, and monitoring configured as part of the fixed-price delivery. No separate infrastructure engagement. Everything needed to go live is included in what you already paid." },
    ],
    "dedicated-team": [
      { serviceName: "Dedicated Engineering Team", slug: "dedicated-teams", description: "Embedded senior engineers in your workflow", applicationDetail: "2-8 senior engineers attending your standups, using your tools, following your standards. They know your codebase because they have been in it for months — context that compounds into velocity." },
      { serviceName: "Frontend Engineering Capacity", slug: "frontend-development", description: "Dedicated frontend engineers for your product", applicationDetail: "Senior frontend engineers embedded in your team who ship features, maintain components, and raise the bar on code quality — without the overhead of hiring, onboarding, or managing them yourself." },
      { serviceName: "Backend Engineering Capacity", slug: "backend-development", description: "Dedicated backend engineers for your platform", applicationDetail: "Senior backend engineers who understand your data model, own their services end to end, and ship reliably sprint after sprint — the same engineers every month, not a rotating cast." },
      { serviceName: "Delivery Operations", slug: "devops", description: "Sprint process and deployment pipeline management", applicationDetail: "Sprint planning, backlog grooming, velocity tracking, CI/CD maintenance, and the delivery infrastructure that keeps your dedicated team productive without requiring daily management from you." },
    ],
    "tech-cofounder": [
      { serviceName: "CTO-Level Technical Strategy", slug: "backend-development", description: "Architecture decisions and hands-on implementation", applicationDetail: "Technology selection, system design, scalability planning, and hands-on architecture implementation — not just strategy slides, but the critical path code that proves the vision is achievable." },
      { serviceName: "Product Development Execution", slug: "frontend-development", description: "Frontend product built to your technical vision", applicationDetail: "Frontend development executed against the architecture your technical co-founder has designed — senior engineers who implement with the same standards the CTO would hold themselves to." },
      { serviceName: "Investor Technical Relations", slug: "cloud-consulting", description: "Infrastructure strategy and technical due diligence support", applicationDetail: "Cloud architecture decisions, technical roadmap, board updates, and the due diligence support that comes from having a named technical leader who can answer investor questions with authority." },
      { serviceName: "Engineering Team Building", slug: "dedicated-teams", description: "Building and managing your engineering function", applicationDetail: "Job descriptions, candidate sourcing, technical interviews, offer negotiation, and onboarding — building the engineering team with CTO-level judgment so your first hires set the right standard." },
    ],
    "cto-as-a-service": [
      { serviceName: "Architecture Reviews", slug: "software-auditing", description: "System design evaluation and technical direction", applicationDetail: "Weekly architecture reviews that resolve technical debates, set direction, and ensure your team builds consistently toward a coherent long-term technical vision — not whatever seemed fastest last sprint." },
      { serviceName: "Technology & Infrastructure Strategy", slug: "cloud-consulting", description: "Build-vs-buy, vendor, and infrastructure decisions", applicationDetail: "Framework evaluation, vendor selection, cloud infrastructure decisions, and the strategic thinking that prevents expensive technology mistakes before they get built into your architecture." },
      { serviceName: "Engineering Oversight", slug: "backend-development", description: "Technical standards and backend architectural guidance", applicationDetail: "Code review standards, backend architecture direction, technical debt prioritisation, and the engineering rigour that keeps your team building toward a system that scales rather than one that needs a rewrite." },
      { serviceName: "Engineering Team Scaling", slug: "dedicated-teams", description: "Hiring strategy and team structure guidance", applicationDetail: "When to hire, who to hire, how to evaluate candidates, and how to structure your engineering organisation as it grows — the team-building judgment that takes years of experience to develop and seconds to get wrong." },
    ],
    "design-sprint": [
      { serviceName: "Sprint Facilitation & User Testing", slug: "ux-ui-design", description: "Structured 5-day product validation with real users", applicationDetail: "Monday problem definition through Friday user testing: structured facilitation, hypothesis testing, and synthesised insights delivered the same day — so you leave the week knowing what to build, not guessing." },
      { serviceName: "Brand Direction Testing", slug: "startup-branding", description: "Brand positioning validated during the sprint", applicationDetail: "Day 2 includes brand direction exploration. By Friday you know which visual and messaging direction resonates with your target users — validated by real reactions, not internal opinions." },
      { serviceName: "Rapid Prototype Build", slug: "frontend-development", description: "High-fidelity clickable prototype in one day", applicationDetail: "A high-fidelity prototype built on Thursday that feels real enough for users to react authentically during Friday testing — not a rough wireframe, but something that convincingly simulates the real product." },
      { serviceName: "Technical Architecture Output", slug: "backend-development", description: "Development specification from validated sprint findings", applicationDetail: "If the sprint validates your direction, we deliver a development specification covering backend architecture, data models, API contracts, and the technical decisions that should be made before engineering begins." },
    ],
    "code-audit": [
      { serviceName: "Full Codebase Review", slug: "software-auditing", description: "Architecture, quality, and maintainability assessment", applicationDetail: "Complete review of code structure, patterns, test coverage, dependency health, and architecture sustainability. Every finding scored by severity and paired with a recommended fix — a roadmap, not just a report." },
      { serviceName: "Backend Security Assessment", slug: "backend-development", description: "Vulnerability identification in server-side code", applicationDetail: "Dependency vulnerability scanning, authentication and authorisation review, data exposure analysis, SQL injection and injection attack surface, and the backend security findings that matter most for your risk profile." },
      { serviceName: "Frontend Architecture Evaluation", slug: "frontend-development", description: "Frontend code quality and scalability review", applicationDetail: "Component architecture review, bundle size analysis, accessibility audit, dependency health check, and the frontend quality assessment that tells you whether your UI layer can scale with your product." },
      { serviceName: "Infrastructure & Deployment Audit", slug: "devops", description: "CI/CD, hosting, and operational practice review", applicationDetail: "Deployment pipeline review, infrastructure configuration assessment, secrets management audit, monitoring coverage gaps, and the operational findings that reveal whether your production environment is as solid as your code." },
    ],
    "staff-augmentation": [
      { serviceName: "Engineer Placement & Integration", slug: "dedicated-teams", description: "Senior engineers embedded in your existing team", applicationDetail: "1-3 senior engineers integrated into your workflow within a week — attending your standups, following your process, contributing through your code review system, and adopting your standards without friction." },
      { serviceName: "Frontend Specialist Placement", slug: "frontend-development", description: "Senior React and frontend engineers on demand", applicationDetail: "React, Next.js, and TypeScript specialists placed into your team for a frontend rebuild, a performance overhaul, or the sustained feature velocity your current team cannot deliver alone." },
      { serviceName: "Backend Specialist Placement", slug: "backend-development", description: "Senior backend and API engineers on demand", applicationDetail: "Node.js, Python, and database specialists placed into your team for API development, architecture improvements, or the backend capacity your roadmap demands without the timeline of a permanent hire." },
      { serviceName: "DevOps Expert Placement", slug: "devops", description: "DevOps and infrastructure specialists on demand", applicationDetail: "CI/CD, cloud infrastructure, and deployment specialists placed into your team for a migration, a reliability improvement, or the DevOps maturity upgrade your engineering team needs but does not have time to build." },
    ],
    "retainer": [
      { serviceName: "Dedicated Engineering Retainer", slug: "dedicated-teams", description: "Consistent engineering capacity month to month", applicationDetail: "Same engineers every month who know your codebase, understand your roadmap, and can estimate accurately — the compounding context that makes retainer velocity higher than project-by-project engagement." },
      { serviceName: "Continuous Frontend Delivery", slug: "frontend-development", description: "Monthly frontend feature development and improvements", applicationDetail: "Ongoing frontend feature development, UI improvements, and iterations delivered on a monthly cadence. Predictable output, predictable cost, no re-scoping every time you need something built." },
      { serviceName: "Backend Maintenance & Advisory", slug: "backend-development", description: "Backend maintenance, bug fixes, and architecture guidance", applicationDetail: "Priority response for production issues, bug fixes within SLA, dependency and security updates, and the ongoing architecture guidance that keeps your backend evolving in the right direction." },
      { serviceName: "CTO as a Service", slug: "cto-as-a-service", description: "Ongoing technical leadership alongside your retainer", applicationDetail: "Monthly architecture reviews, technology decisions, and strategic technical oversight bundled into your retainer — consistent senior leadership that ensures your product evolves in the right direction month over month." },
    ],
    "nearshore": [
      { serviceName: "Nearshore Engineering Model", slug: "nearshore", description: "Senior engineers within 2 hours of your timezone", applicationDetail: "Full-stack engineers close enough for real-time collaboration, pair programming, and same-day problem resolution — at 40-60% of local rates, without the communication overhead of offshore." },
      { serviceName: "Nearshore Frontend Team", slug: "frontend-development", description: "Frontend engineers in your timezone", applicationDetail: "Senior React and Next.js engineers embedded in your workflow — same standup, same Slack, same code reviews. The only difference from a local frontend hire is the invoice amount." },
      { serviceName: "Nearshore Backend Team", slug: "backend-development", description: "Backend engineers in your timezone", applicationDetail: "Senior backend engineers in your timezone who communicate fluently, follow your engineering process, and deliver the same code quality you expect from local hires at a fraction of the cost." },
      { serviceName: "Dedicated Nearshore Team", slug: "dedicated-teams", description: "Full embedded nearshore engineering team", applicationDetail: "A complete nearshore engineering squad embedded in your workflow — attending your standups, using your tools, shipping through your review process, and accumulating codebase context month over month." },
    ],
    "outsourcing": [
      { serviceName: "Full Project Outsourcing", slug: "outsourcing", description: "End-to-end delivery with complete ownership", applicationDetail: "Requirements in, working software out. We own architecture, development, testing, deployment, and documentation. One contract, one deliverable, milestone payments on working software — not hours logged." },
      { serviceName: "Frontend Delivery", slug: "frontend-development", description: "Frontend designed, built, and delivered", applicationDetail: "Complete frontend development from design through deployment — component architecture, responsive implementation, performance optimisation, and handover with full documentation your future team can use." },
      { serviceName: "Backend Delivery", slug: "backend-development", description: "Backend engineered, tested, and handed over", applicationDetail: "API design, database architecture, business logic, integrations, and deployment — all delivered with architecture documentation, API contracts, and the knowledge transfer that makes you independent of us." },
      { serviceName: "UX & Design Delivery", slug: "ux-ui-design", description: "Design included in the outsourced scope", applicationDetail: "User research, wireframes, high-fidelity design, and a design system delivered as part of your outsourced project — so you receive a complete product, not working software that still needs a designer." },
    ],
  };
...
function getCloudCard(id: string, category: string): StartupServiceApplication {
  const perStartup: Record<string, StartupServiceApplication> = {
    // BY STAGE
    "pre-idea": { serviceName: "Pre-Launch Cloud Planning", slug: "cloud-consulting", description: "Infrastructure thinking before you build", applicationDetail: "Choose the right cloud stack before writing a line of code. We advise on provider selection, architecture approach, and the decisions that are cheapest to make early." },
    "validation": { serviceName: "Validation-Stage Infrastructure", slug: "cloud-consulting", description: "Cloud setup sized for testing, not production", applicationDetail: "Infrastructure configured for validation speed: fast deploys, easy resets, and costs that fit a pre-revenue budget while your architecture stays production-compatible." },
    "mvp": { serviceName: "MVP Cloud Architecture", slug: "cloud-consulting", description: "Production-ready cloud from day one", applicationDetail: "Architecture that handles your launch traffic and scales without a rewrite. We design for the next 18 months, not just the first week." },
    "early-traction": { serviceName: "Traction-Stage Cloud Scaling", slug: "cloud-consulting", description: "Infrastructure for your first growth spike", applicationDetail: "Auto-scaling configuration, database connection pooling, and the caching strategy that keeps your product stable as user count multiplies unexpectedly." },
    "seed-stage": { serviceName: "Seed-Stage Cloud Strategy", slug: "cloud-consulting", description: "Investor-credible infrastructure planning", applicationDetail: "Cloud architecture that handles your next 12 months of growth, documented well enough to pass technical due diligence. Built with seed-stage economics in mind." },
    "series-a": { serviceName: "Series A Infrastructure Scale", slug: "cloud-consulting", description: "Cloud architecture for accelerated growth", applicationDetail: "Infrastructure strategy for the 10x growth that Series A funding enables. Multi-region readiness, reliability SLAs, and the team processes that make deployment boring." },
    "series-b-plus": { serviceName: "Enterprise Cloud Architecture", slug: "cloud-consulting", description: "Multi-region, enterprise-grade infrastructure", applicationDetail: "Cloud architecture for companies with complex reliability requirements: multi-region active-active, disaster recovery, compliance controls, and internal SLA enforcement." },
    "bootstrapped": { serviceName: "Cost-Optimized Cloud Setup", slug: "cloud-consulting", description: "Maximum infrastructure for minimum spend", applicationDetail: "Cloud architecture that punches above its budget: spot instances, reserved pricing, right-sizing, and the optimizations that cut your AWS bill by 40-60% without sacrificing reliability." },
    "growth": { serviceName: "Growth-Phase Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure strategy for compounding scale", applicationDetail: "Cloud architecture that grows with your user base without emergency incidents. Proactive capacity planning, database scaling strategy, and the reliability engineering that protects revenue." },
    "scale-up": { serviceName: "Scale-Up Cloud Infrastructure", slug: "cloud-consulting", description: "Enterprise-scale infrastructure strategy", applicationDetail: "Cloud architecture for high-scale operations: distributed systems design, multi-region active-active, data residency compliance, and the reliability that enterprise customers require." },
    // BY VERTICAL
    "fintech": { serviceName: "Fintech Cloud & Compliance Architecture", slug: "cloud-consulting", description: "PCI-DSS and SOC 2 compliant infrastructure strategy", applicationDetail: "Cloud architecture where compliance is designed in, not bolted on. PCI-DSS scope minimization, SOC 2 evidence automation, and the provider configurations that pass financial audits." },
    "healthtech": { serviceName: "HIPAA-Compliant Cloud Strategy", slug: "cloud-consulting", description: "Healthcare infrastructure with built-in compliance", applicationDetail: "BAA-covered cloud architecture with encryption everywhere, audit logging by default, and the access controls that satisfy HIPAA Security Rule requirements without security theater." },
    "edtech": { serviceName: "EdTech Scaling Infrastructure", slug: "cloud-consulting", description: "Cloud strategy for enrollment spikes and streaming costs", applicationDetail: "Architecture for 5x traffic spikes during enrollment, cost-optimized video delivery for global learners, and the auto-scaling that keeps your platform stable during peak load." },
    "proptech": { serviceName: "PropTech Platform Architecture", slug: "cloud-consulting", description: "Infrastructure for geospatial and listing data at scale", applicationDetail: "Cloud strategy for high-performance property search: PostGIS optimization, tile server architecture, MLS feed ingestion, and the database design that returns results in under 200ms." },
    "legaltech": { serviceName: "LegalTech Data Architecture", slug: "cloud-consulting", description: "Privilege-protected infrastructure strategy", applicationDetail: "Cloud architecture where data access controls map directly to attorney-client privilege boundaries. Audit trails, encryption by default, and the infrastructure that survives discovery requests." },
    "ai-startup": { serviceName: "AI Infrastructure Strategy", slug: "cloud-consulting", description: "Cloud architecture for LLMs, RAG, and inference at scale", applicationDetail: "GPU instance strategy, vector database selection, inference cost modeling, and the architecture that keeps per-query costs predictable as your user base scales." },
    "logistics-tech": { serviceName: "Real-Time Logistics Cloud", slug: "cloud-consulting", description: "Infrastructure for high-frequency location and routing data", applicationDetail: "Cloud strategy for real-time fleet tracking: event streaming architecture, time-series data storage, CDN for driver apps, and the infrastructure that handles 1,000+ vehicles without lag." },
    "ecommerce": { serviceName: "High-Traffic Commerce Cloud", slug: "cloud-consulting", description: "Infrastructure strategy for flash sales and holiday peaks", applicationDetail: "Cloud architecture for commerce workloads: edge caching, database read replicas, image optimization CDN, and the auto-scaling that keeps checkout conversion high during traffic spikes." },
    "b2b-saas": { serviceName: "Multi-Tenant SaaS Architecture", slug: "cloud-consulting", description: "Cloud strategy for isolated, scalable SaaS hosting", applicationDetail: "Tenant isolation architecture, per-tenant resource limits, SOC 2-ready logging, and the database strategy that keeps one enterprise customer from affecting another." },
    "consumer-apps": { serviceName: "Consumer App Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure for social features and real-time engagement", applicationDetail: "Cloud architecture for consumer scale: WebSocket infrastructure, push notification pipelines, CDN for media, and the database sharding strategy that handles millions of daily active users." },
    // BY PRODUCT TYPE
    "web-app": { serviceName: "Web App Cloud Architecture", slug: "cloud-consulting", description: "Cloud strategy for full-stack web applications", applicationDetail: "Hosting selection, database configuration, CDN setup, and the deployment pipeline that makes shipping a web app boring. Right choice at every layer for your traffic pattern." },
    "mobile-app": { serviceName: "Mobile Backend Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure for mobile API and push systems", applicationDetail: "Cloud architecture for mobile backends: API gateway, push notification infrastructure, offline sync strategy, and the database design that keeps mobile apps fast on 4G connections." },
    "ai-product": { serviceName: "AI & ML Cloud Infrastructure", slug: "cloud-consulting", description: "Cloud strategy for inference, embeddings, and model serving", applicationDetail: "GPU provisioning strategy, vector database selection, inference cost modeling, and the cloud architecture that keeps AI product costs predictable as usage scales." },
    "saas-platform": { serviceName: "SaaS Platform Cloud Strategy", slug: "cloud-consulting", description: "Multi-tenant hosting and operational infrastructure", applicationDetail: "Tenant isolation at the infrastructure level, per-tenant usage metering, SOC 2 logging configuration, and the cloud architecture that enterprise procurement teams expect." },
    "marketplace": { serviceName: "Marketplace Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure for two-sided marketplace workloads", applicationDetail: "Cloud strategy for marketplace scale: search infrastructure, image CDN, payment processing reliability, and the database design that handles buyer-seller matching at volume." },
    "api-product": { serviceName: "API Platform Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure for high-throughput API delivery", applicationDetail: "API gateway configuration, rate limiting infrastructure, global CDN distribution, and the cloud architecture that keeps p99 latency low as your developer customer base grows." },
    "data-platform": { serviceName: "Data Platform Cloud Architecture", slug: "cloud-consulting", description: "Cloud strategy for warehouses, pipelines, and analytics", applicationDetail: "Warehouse selection and configuration, orchestration infrastructure, query cost optimization, and the data architecture that keeps your analytics platform fast and affordable at scale." },
    "iot": { serviceName: "IoT & Edge Cloud Strategy", slug: "cloud-consulting", description: "Cloud architecture for device fleets and telemetry", applicationDetail: "MQTT broker infrastructure, time-series database strategy, edge computing architecture, and the cloud design that processes device data at scale without a linear cost increase." },
    "internal-tools": { serviceName: "Internal Tools Cloud Setup", slug: "cloud-consulting", description: "Right-sized infrastructure for internal applications", applicationDetail: "Cloud setup that matches your internal tools' actual requirements: simple, maintainable, secure, and far cheaper than the enterprise infrastructure most vendors try to sell you." },
    "embedded": { serviceName: "Connected Device Cloud Strategy", slug: "cloud-consulting", description: "Cloud architecture for device management and OTA", applicationDetail: "Cloud infrastructure for connected devices: device registry, OTA update delivery, telemetry ingestion, and the architecture that scales from 1,000 to 1,000,000 devices." },
    // BY FOUNDER TYPE
    "non-technical-founder": { serviceName: "Plain-Language Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure guidance without the jargon", applicationDetail: "We explain every cloud decision in business terms: what it costs, what it prevents, and what happens if we skip it. You make informed choices without needing a CS degree." },
    "first-time-founder": { serviceName: "First-Startup Cloud Guidance", slug: "cloud-consulting", description: "Cloud decisions explained for first-time founders", applicationDetail: "Provider selection, architecture basics, and the cloud decisions that are expensive to undo. We explain the choices once so you understand them forever." },
    "solo-founder": { serviceName: "Solo Founder Cloud Setup", slug: "cloud-consulting", description: "Infrastructure that runs itself while you focus on product", applicationDetail: "Cloud architecture built for minimal operational overhead: managed services where possible, automated monitoring, and the setup that does not page you at 2am." },
    "repeat-founder": { serviceName: "Architect-Level Cloud Strategy", slug: "cloud-consulting", description: "Peer-level cloud architecture consultation", applicationDetail: "Architecture review, provider strategy, and scaling decisions from engineers who have made these choices 50+ times. Peer-to-peer, no hand-holding required." },
    "student-startup": { serviceName: "Budget-Smart Cloud Architecture", slug: "cloud-consulting", description: "Maximum capability at minimum cost", applicationDetail: "AWS Activate credits, free tier optimization, and the architecture that gives you production capability at near-zero cost until you have revenue to justify the upgrade." },
    "corporate-innovator": { serviceName: "Enterprise Cloud Integration", slug: "cloud-consulting", description: "Cloud strategy that works within corporate constraints", applicationDetail: "Cloud architecture that satisfies corporate InfoSec, uses approved providers, and meets your organization's compliance requirements while still moving at startup speed." },
    "female-led": { serviceName: "Founder-Led Cloud Strategy", slug: "cloud-consulting", description: "Transparent cloud guidance with no surprises", applicationDetail: "Every architecture decision explained with full context: options, tradeoffs, costs, and recommendations. No information asymmetry, no dependency created on purpose." },
    "african-startup": { serviceName: "African Market Cloud Setup", slug: "cloud-consulting", description: "Cloud architecture optimized for African markets", applicationDetail: "CDN endpoints near African users, mobile money payment infrastructure, low-bandwidth optimization, and hosting costs calibrated to your market's revenue economics." },
    "diaspora-founder": { serviceName: "Multi-Market Cloud Architecture", slug: "cloud-consulting", description: "Cloud strategy for products serving multiple countries", applicationDetail: "Multi-region deployment, data residency compliance per country, cross-border latency optimization, and the cloud architecture that serves users in two continents at the same quality." },
    "social-enterprise": { serviceName: "Mission-Aligned Cloud Strategy", slug: "cloud-consulting", description: "Infrastructure that fits grant budgets and nonprofit economics", applicationDetail: "Google for Nonprofits credits, AWS program eligibility, and the cloud architecture that maximizes your technology capability per grant dollar spent." },
    // BY CHALLENGE
    "fast-mvp": { serviceName: "Launch-Ready Cloud Setup", slug: "cloud-consulting", description: "Cloud configured to ship on day one", applicationDetail: "Deployment pipeline, hosting, database, and monitoring configured before feature work begins. Your infrastructure is production-ready when your code is." },
    "scaling-tech": { serviceName: "Scaling Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure strategy for your growth bottleneck", applicationDetail: "Cloud architecture review focused on your specific scaling constraint. Database replication, caching strategy, horizontal scaling design, and the infrastructure fixes with the highest impact." },
    "agency-rescue": { serviceName: "Infrastructure Rescue Plan", slug: "cloud-consulting", description: "Cloud audit and remediation for inherited systems", applicationDetail: "Assessment of the cloud infrastructure you inherited: costs, risks, technical debt, and the prioritized remediation plan that stabilizes before optimizing." },
    "fundraising-ready": { serviceName: "Investor-Ready Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure that survives technical due diligence", applicationDetail: "Cloud documentation, architecture diagrams, cost analysis, and security posture prepared for the technical review that serious investors commission before writing checks." },
    "ai-integration": { serviceName: "AI-Ready Cloud Infrastructure", slug: "cloud-consulting", description: "Cloud strategy for AI feature deployment", applicationDetail: "Infrastructure assessment for AI workloads: GPU availability, vector database options, inference cost modeling, and the cloud architecture changes that your AI features require." },
    "tech-debt": { serviceName: "Infrastructure Modernization Plan", slug: "cloud-consulting", description: "Cloud strategy as part of technical debt reduction", applicationDetail: "Assessment of infrastructure debt: outdated services, manual processes, missing automation, and the modernization roadmap that reduces operational burden alongside codebase cleanup." },
    "security-compliance": { serviceName: "Compliant Cloud Architecture", slug: "cloud-consulting", description: "Cloud strategy built around your compliance framework", applicationDetail: "Infrastructure architecture that maps to your specific compliance requirements: SOC 2, HIPAA, PCI-DSS, or GDPR. Evidence generation automated, audit preparation built in." },
    "post-pivot": { serviceName: "Post-Pivot Cloud Reset", slug: "cloud-consulting", description: "Infrastructure realignment for your new direction", applicationDetail: "Cloud assessment against your pivoted product requirements. Keep what transfers, replace what does not, and configure the infrastructure your new direction actually needs." },
    "no-tech-team": { serviceName: "Fully Managed Cloud Strategy", slug: "cloud-consulting", description: "Cloud architecture designed for zero internal ops", applicationDetail: "Managed services everywhere possible. Automated monitoring and alerting. Full documentation. Your infrastructure runs reliably without an engineering team watching it." },
    "africa-launch": { serviceName: "Africa-Ready Cloud Architecture", slug: "cloud-consulting", description: "Cloud strategy for African market entry", applicationDetail: "CDN presence near African users, data localization for countries that require it, mobile money payment infrastructure, and hosting economics aligned to African market revenue." },
    // BY ENGAGEMENT
    "fixed-price-mvp": { serviceName: "Cloud Setup (Included)", slug: "cloud-consulting", description: "Infrastructure configuration bundled with your build", applicationDetail: "Cloud architecture designed and configured as part of your fixed-price delivery. Hosting, deployment pipeline, monitoring, and database setup included in scope." },
    "dedicated-team": { serviceName: "Dedicated Cloud Operations", slug: "cloud-consulting", description: "Cloud strategy managed alongside your dedicated team", applicationDetail: "Ongoing cloud architecture decisions, cost optimization, and infrastructure evolution managed by your dedicated team. No separate infrastructure engagement required." },
    "design-sprint": { serviceName: "Infrastructure Scoping Session", slug: "cloud-consulting", description: "Cloud requirements defined during your sprint", applicationDetail: "Day 1 of your design sprint includes infrastructure scoping. By Friday, cloud provider, architecture approach, and estimated costs are defined alongside the product direction." },
    "code-audit": { serviceName: "Cloud Infrastructure Audit", slug: "cloud-consulting", description: "Infrastructure assessment alongside code review", applicationDetail: "Cloud costs, architecture risks, provider lock-in, and security posture assessed in parallel with your codebase review. Full picture of technical health delivered together." },
    "staff-augmentation": { serviceName: "Cloud Expertise Placement", slug: "cloud-consulting", description: "Cloud specialist joining your team", applicationDetail: "Cloud architect or DevOps specialist integrated into your team for the duration of your infrastructure challenge. Works in your tooling, follows your process." },
    "nearshore": { serviceName: "Nearshore Cloud Engineering", slug: "cloud-consulting", description: "Cloud operations by timezone-aligned engineers", applicationDetail: "Cloud architecture and operations managed by nearshore engineers in your timezone. Real-time collaboration on infrastructure decisions without async-only communication." },
    "outsourcing": { serviceName: "Cloud Architecture Delivery", slug: "cloud-consulting", description: "Infrastructure designed and delivered as part of your project", applicationDetail: "Cloud architecture included in our outsourced delivery scope. You receive documented, production-grade infrastructure alongside your software. One handoff, complete." },
  };

  if (perStartup[id]) return perStartup[id];

  const fallbackByCategory: Record<string, StartupServiceApplication> = {
    "By Stage": { serviceName: "Stage-Appropriate Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure planning for your stage", applicationDetail: "Right-sized cloud architecture for your current scale with a clear path to grow. No over-engineering, no premature optimization, no surprise bills." },
    "By Vertical": { serviceName: "Industry-Specific Cloud Strategy", slug: "cloud-consulting", description: "Cloud architecture for your market's requirements", applicationDetail: "Infrastructure designed around the compliance, performance, and reliability requirements of your specific industry vertical." },
    "By Product Type": { serviceName: "Product Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure matched to your product type", applicationDetail: "Cloud strategy tailored to the workload characteristics of your product: latency requirements, data volume, real-time needs, and the growth trajectory you are planning for." },
    "By Founder Type": { serviceName: "Founder-Ready Cloud Strategy", slug: "cloud-consulting", description: "Technical strategy and advisory", applicationDetail: "Architecture decisions, vendor selection, and technology roadmap guidance from engineers who have made these choices 50+ times before." },
    "By Challenge": { serviceName: "Challenge-Specific Cloud Architecture", slug: "cloud-consulting", description: "Infrastructure strategy for your current challenge", applicationDetail: "Cloud architecture targeted at the specific technical challenge you face. Whether scaling, migrating, or securing: infrastructure designed for your problem, not the generic case." },
    "By Engagement": { serviceName: "Cloud Architecture (Included)", slug: "cloud-consulting", description: "Infrastructure built into your engagement", applicationDetail: "Cloud architecture and consulting included in your engagement scope. No separate infrastructure vendor required." },
  };
  return fallbackByCategory[category] ?? fallbackByCategory["By Vertical"];
}
...
function generateAdditionalServices(_id: string, category: string, existingSlugs: string[]): StartupServiceApplication[] {
  ...
  const additionalByCategory: Record<string, StartupServiceApplication[]> = {
    "By Vertical": [
      { serviceName: "Cloud Infrastructure Setup", slug: "backend-development", description: "Production-grade hosting and scaling", applicationDetail: "AWS, GCP, or Azure architecture designed for your traffic patterns. Auto-scaling, multi-region deployment, and the infrastructure that grows with your user base." },
      { serviceName: "Automated Testing", slug: "software-auditing", description: "Quality assurance at speed", applicationDetail: "End-to-end test suites, integration testing, and CI pipelines that catch regressions before they reach production. Ship daily without manual QA bottlenecks." },
      { serviceName: "Security Posture Review", slug: "software-auditing", description: "Proactive security assessment", applicationDetail: "Vulnerability scanning, dependency auditing, and penetration testing that identifies risks before attackers do. Compliance-ready documentation included." },
    ...
    "By Product Type": [
      { serviceName: "Cloud Infrastructure", slug: "backend-development", description: "Hosting and deployment architecture", applicationDetail: "Infrastructure designed for your product's specific requirements: compute-heavy workloads, data-intensive pipelines, or globally distributed users." },
      { serviceName: "Test Automation", slug: "software-auditing", description: "Regression prevention at scale", applicationDetail: "Automated test suites covering critical paths, integration points, and edge cases. Confidence to ship frequently without fear of breaking existing features." },
    ...
    "By Stage": [
      ...
      { serviceName: "Security Audit", slug: "software-auditing", description: "Security posture for your growth stage", applicationDetail: "Appropriate security measures for where you are now. Seed stage needs different controls than Series B. We right-size security to your risk profile." },
    ],
    "By Founder Type": [
    ...
    "By Challenge": [
      { serviceName: "Cloud Engineering", slug: "backend-development", description: "Infrastructure that matches your challenge", applicationDetail: "Whether scaling, migrating, or rebuilding: cloud architecture designed for the specific technical challenge you face today." },
    ...
    "By Engagement": [
      { serviceName: "Cloud Engineering", slug: "backend-development", description: "Infrastructure included in every engagement", applicationDetail: "Regardless of engagement type, your infrastructure is production-grade: CI/CD, monitoring, auto-scaling, and the operational foundation that keeps things running." },
      { serviceName: "Security & Compliance", slug: "software-auditing", description: "Security built into our delivery process", applicationDetail: "Every engagement includes security best practices: dependency scanning, secret management, access controls, and vulnerability assessment as standard." },
      { serviceName: "Test Automation", slug: "software-auditing", description: "Quality assurance in every delivery", applicationDetail: "Automated tests on critical paths are standard in all our engagements. No manual QA bottleneck. Confidence to deploy on any day." },
