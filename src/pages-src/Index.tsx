...
const values = [
  ...
  { icon: Shield, title: "You Own Everything", line: <><span style={{ color: "hsl(1,77%,55%)" }}>Code</span>{", "}<span style={{ color: "hsl(335,55%,49%)" }}>designs</span>{", "}<span style={{ color: "hsl(292,51%,46%)" }}>IP</span>{": "}<span style={{ color: "hsl(263,84%,58%)" }}>yours at each paid milestone.</span></> },
];
