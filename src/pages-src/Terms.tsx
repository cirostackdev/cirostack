    ...
    <section className="section-padding">
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>For questions about these terms, please contact us at <a href="mailto:cirostack@gmail.com" className="text-primary hover:underline">cirostack@gmail.com</a>.</p>
        </div>
      </div>
    </section>
  </Layout>
